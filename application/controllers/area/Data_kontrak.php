...
class Data_kontrak extends CI_Controller
{
    ...
    {
        parent::__construct();
        $this->load->model('Area/Data_kontrak_model');
    }
    ...
    public function index()
    {
        ...
        $this->load->view('area/kontrak_management/index', $data);
        $this->load->view('template/footer_ui');
        $this->load->view('area/kontrak_management/ajax');
    }

    public function get_data()
    {
        $id_area = $this->session->userdata('id_area');
        $resultss = $this->Data_kontrak_model->getdatatable($id_area);
        $data = [];
        $no = $_POST['start'];
        ...
        $output = array(
            "draw" => $_POST['draw'],
            "recordsTotal" => $this->Data_kontrak_model->count_all_data($id_area),
            "recordsFiltered" => $this->Data_kontrak_model->count_filtered_data($id_area),
            "data" => $data
        );
