...
class Tagihan_kontrak extends CI_Controller
{
    ...
    public function by_no_kontrak($no_kontrak)
    {
        ...
        $selact_max2 = $this->Tagihan_kontrak_model->get_last_mc_jumlah($no_kontrak);


        $cek_pertama_mc_apa = $this->Tagihan_kontrak_model->cek_pertama_mc_apa($no_kontrak);
    ...
    public function tambah_mc()
    {
        ...
        $hitung_persen_total_ppn = ($jumlah_mc * 10) / 100;
    ...
    public function by_id_mc($id_mc)
    {
        ...
        $get_traking_vendor = $this->Tagihan_kontrak_model->get_traking_vendor($id_mc);
        $get_traking_area = $this->Tagihan_kontrak_model->get_traking_area($id_mc);
        $get_traking_pusat = $this->Tagihan_kontrak_model->get_traking_pusat($id_mc);
        $get_traking_finance = $this->Tagihan_kontrak_model->get_traking_finance($id_mc);
