...
if ($type_add =='1') {
    ...
    $data = [
        'nilai_sdm_add_I' => $this->input->post('nilai_sdm'),
    ];
    ...
    $data = [
        'nilai_sdm_add_II' => $this->input->post('nilai_sdm'),
    ];
    $this->Data_kontrak_model->update_tbl_sdm($where, $data);
    // update after
    $row_sdm = $this->Data_kontrak_model->by_id_sdm($id_sdm);
    ...
    $data = [
        'nilai_sdm_add_III' => $this->input->post('nilai_sdm'),
    ];
    $this->Data_kontrak_model->update_tbl_sdm($where, $data);
    // update after
    $row_sdm = $this->Data_kontrak_model->by_id_sdm($id_sdm);
    ...
    $data = [
        'nilai_sdm_add_IV' => $this->input->post('nilai_sdm'),
    ];
    $this->Data_kontrak_model->update_tbl_sdm($where, $data);
    // update after
    $row_sdm = $this->Data_kontrak_model->by_id_sdm($id_sdm);
    ...
    $data = [
        'nilai_sdm_add_V' => $this->input->post('nilai_sdm'),
    ];
    $this->Data_kontrak_model->update_tbl_sdm($where, $data);
    // update after
    $row_sdm = $this->Data_kontrak_model->by_id_sdm($id_sdm);
    ...
    $data = [
        'nilai_sdm_add_VI' => $this->input->post('nilai_sdm'),
    ];
    $this->Data_kontrak_model->update_tbl_sdm($where, $data);
    // update after
    $row_sdm = $this->Data_kontrak_model->by_id_sdm($id_sdm);
    ...
    $data = [
        'nilai_sdm_add_VII' => $this->input->post('nilai_sdm'),
    ];
    $this->Data_kontrak_model->update_tbl_sdm($where, $data);
    // update after
    $row_sdm = $this->Data_kontrak_model->by_id_sdm($id_sdm);
    ...
    $data = [
        'nilai_sdm_add_VIII' => $this->input->post('nilai_sdm'),
    ];
    $this->Data_kontrak_model->update_tbl_sdm($where, $data);
    // update after
    $row_sdm = $this->Data_kontrak_model->by_id_sdm($id_sdm);
    ...
    $data = [
        'nilai_sdm_add_IX' => $this->input->post('nilai_sdm'),
    ];
    $this->Data_kontrak_model->update_tbl_sdm($where, $data);
    // update after
    $row_sdm = $this->Data_kontrak_model->by_id_sdm($id_sdm);
    ...
    $data = [
        'nilai_sdm_add_X' => $this->input->post('nilai_sdm'),
    ];
    $this->Data_kontrak_model->update_tbl_sdm($where, $data);
    // update after
    $row_sdm = $this->Data_kontrak_model->by_id_sdm($id_sdm);
    ...
    $data = [
        'nilai_sdm_add_XI' => $this->input->post('nilai_sdm'),
    ];
    $this->Data_kontrak_model->update_tbl_sdm($where, $data);
    // update after
    $row_sdm = $this->Data_kontrak_model->by_id_sdm($id_sdm);
    ...
    $data = [
        'nilai_sdm_add_XII' => $this->input->post('nilai_sdm'),
    ];
    $this->Data_kontrak_model->update_tbl_sdm($where, $data);
    // update after
    $row_sdm = $this->Data_kontrak_model->by_id_sdm($id_sdm);
    ...
    $data = [
        'nilai_sdm_add_XIII' => $this->input->post('nilai_sdm'),
    ];
    $this->Data_kontrak_model->update_tbl_sdm($where, $data);
    // update after
    $row_sdm = $this->Data_kontrak_model->by_id_sdm($id_sdm);
    ...
    $data = [
        'nilai_sdm_add_XIV' => $this->input->post('nilai_sdm'),
    ];
    $this->Data_kontrak_model->update_tbl_sdm($where, $data);
    // update after
    $row_sdm = $this->Data_kontrak_model->by_id_sdm($id_sdm);
    ...
    $data = [
        'nilai_sdm_add_XV' => $this->input->post('nilai_sdm'),
    ];
    $this->Data_kontrak_model->update_tbl_sdm($where, $data);
    // update after
    $row_sdm = $this->Data_kontrak_model->by_id_sdm($id_sdm);
    ...
    $data = [
        'nilai_sdm_add_XVI' => $this->input->post('nilai_sdm'),
    ];
    $this->Data_kontrak_model->update_tbl_sdm($where, $data);
    // update after
    $row_sdm = $this->Data_kontrak_model->by_id_sdm($id_sdm);
    ...
    $data = [
        'nilai_sdm_add_XVII' => $this->input->post('nilai_sdm'),
    ];
    $this->Data_kontrak_model->update_tbl_sdm($where, $data);
    // update after
    $row_sdm = $this->Data_kontrak_model->by_id_sdm($id_sdm);
    ...
    $data = [
        'nilai_sdm_add_XVIII' => $this->input->post('nilai_sdm'),
    ];
    $this->Data_kontrak_model->update_tbl_sdm($where, $data);
    // update after
    $row_sdm = $this->Data_kontrak_model->by_id_sdm($id_sdm);
    ...
    $data = [
        'nilai_sdm_add_XIX' => $this->input->post('nilai_sdm'),
    ];
    $this->Data_kontrak_model->update_tbl_sdm($where, $data);
    // update after
    $row_sdm = $this->Data_kontrak_model->by_id_sdm($id_sdm);
    ...
    $data = [
        'nilai_sdm_add_XX' => $this->input->post('nilai_sdm'),
    ];
    $this->Data_kontrak_model->update_tbl_sdm($where, $data);
    // update after
    $row_sdm = $this->Data_kontrak_model->by_id_sdm($id_sdm);
    ...
    $data = [
        'nilai_sdm_add_XXI' => $this->input->post('nilai_sdm'),
    ];
    $this->Data_kontrak_model->update_tbl_sdm($where, $data);
    // update after
    $row_sdm = $this->Data_kontrak_model->by_id_sdm($id_sdm);
    ...
    $data = [
        'nilai_sdm_add_XXII' => $this->input->post('nilai_sdm'),
    ];
    $this->Data_kontrak_model->update_tbl_sdm($where, $data);
    // update after
    $row_sdm = $this->Data_kontrak_model->by_id_sdm($id_sdm);
    ...
    $data = [
        'nilai_sdm_add_XXIII' => $this->input->post('nilai_sdm'),
    ];
    $this->Data_kontrak_model->update_tbl_sdm($where, $data);
    // update after
    $row_sdm = $this->Data_kontrak_model->by_id_sdm($id_sdm);
    ...
    $data = [
        'nilai_sdm_add_XXIV' => $this->input->post('nilai_sdm'),
    ];
    $this->Data_kontrak_model->update_tbl_sdm($where, $data);
    // update after
    $row_sdm = $this->Data_kontrak_model->by_id_sdm($id_sdm);
    ...
    $data = [
        'nilai_sdm_add_XXV' => $this->input->post('nilai_sdm'),
    ];
    $this->Data_kontrak_model->update_tbl_sdm($where, $data);
    // update after
    $row_sdm = $this->Data_kontrak_model->by_id_sdm($id_sdm);
    ...
    $data = [
        'nilai_sdm_add_XXVI' => $this->input->post('nilai_sdm'),
    ];
    $this->Data_kontrak_model->update_tbl_sdm($where, $data);
    // update after
    $row_sdm = $this->Data_kontrak_model->by_id_sdm($id_sdm);
    ...
    $data = [
        'nilai_sdm_add_XXVII' => $this->input->post('nilai_sdm'),
    ];
    $this->Data_kontrak_model->update_tbl_sdm($where, $data);
    // update after
    $row_sdm = $this->Data_kontrak_model->by_id_sdm($id_sdm);
    ...
    $data = [
        'nilai_sdm_add_XXVIII' => $this->input->post('nilai_sdm'),
    ];
    $this->Data_kontrak_model->update_tbl_sdm($where, $data);
    // update after
    $row_sdm = $this->Data_kontrak_model->by_id_sdm($id_sdm);
    ...
    $data = [
        'nilai_sdm_add_XXIX' => $this->input->post('nilai_sdm'),
    ];
    $this->Data_kontrak_model->update_tbl_sdm($where, $data);
    // update after
    $row_sdm = $this->Data_kontrak_model->by_id_sdm($id_sdm);
    ...
    $data = [
        'nilai_sdm_add_XXX' => $this->input->post('nilai_sdm'),
    ];
    $this->Data_kontrak_model->update_tbl_sdm($where, $data);
    // update after
    $row_sdm = $this->Data_kontrak_model->by_id_sdm($id_sdm);
    ...
    $this->output->set_content_type('application/json')->set_output(json_encode('success'));
        ...
        $data = [
            'nilai_sdm' => $this->input->post('nilai_sdm'),
        ];
        $this->Data_kontrak_model->update_tbl_sdm($where, $data);
        // update after
        $row_sdm = $this->Data_kontrak_model->by_id_sdm($id_sdm);
