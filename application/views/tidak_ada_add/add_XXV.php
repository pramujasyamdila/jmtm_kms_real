...
$data_kontrak = [
    'nilai_add_XXV' => $ambil_nilai_kontrak['nilai_kontrak_awal'],
];
...
$data_capex = [
    'nilai_capex_add_XXV' => $ambil_capex['nilai_capex'],
];
...
foreach ($ambil_capex_detail as $key => $value) {
    ...
    $data_capex_detail = [
        'nilai_detail_capex_add_XXV' => $value['nilai_detail_capex'],
    ];
...
foreach ($ambil_capex_detail as $key => $value_capex_detail) {
    ...
    foreach ($query_result_detail_capex_1->result_array() as $value_detail_capex_1) {
        ...
        $data_detail_capex_1 = [
            'nilai_capex_detail_1_add_XXV' => $value_detail_capex_1['nilai_capex_detail_1'],
        ];
        ...
        foreach ($query_result_detail_capex_2->result_array() as $value_detail_capex_2) {
            ...
            $data_detail_capex_2 = [
                'nilai_capex_detail_2_add_XXV' => $value_detail_capex_2['nilai_capex_detail_2'],
            ];
            ...
            foreach ($query_result_detail_capex_3->result_array() as $value_detail_capex_3) {
                ...
                $data_detail_capex_3 = [
                    'nilai_capex_detail_3_add_XXV' => $value_detail_capex_3['nilai_capex_detail_3'],
                ];
                ...
                foreach ($query_result_detail_capex_4->result_array() as $value_detail_capex_4) {
                    ...
                    $data_detail_capex_4 = [
                        'nilai_capex_detail_4_add_XXV' => $value_detail_capex_4['nilai_capex_detail_4'],
                    ];
                    ...
                    foreach ($query_result_detail_capex_5->result_array() as $value_detail_capex_5) {
                        ...
                        $data_detail_capex_5 = [
                            'nilai_capex_detail_5_add_XXV' => $value_detail_capex_5['nilai_capex_detail_5'],
                        ];
                        ...
                        foreach ($query_result_detail_capex_6->result_array() as $value_detail_capex_6) {
                            ...
                            $data_detail_capex_6 = [
                                'nilai_capex_detail_6_add_XXV' => $value_detail_capex_6['nilai_capex_detail_6'],
                            ];
                            ...
                            foreach ($query_result_detail_capex_7->result_array() as $value_detail_capex_7) {
                                ...
                                $data_detail_capex_7 = [
                                    'nilai_capex_detail_7_add_XXV' => $value_detail_capex_7['nilai_capex_detail_7'],
                                ];
                                ...
                                foreach ($query_result_detail_capex_8->result_array() as $value_detail_capex_8) {
                                    ...
                                    $data_detail_capex_8 = [
                                        'nilai_capex_detail_8_add_XXV' => $value_detail_capex_8['nilai_capex_detail_8'],
                                    ];
                                    ...
                                    foreach ($query_result_detail_capex_9->result_array() as $value_detail_capex_9) {
                                        ...
                                        $data_detail_capex_9 = [
                                            'nilai_capex_detail_9_add_XXV' => $value_detail_capex_9['nilai_capex_detail_9'],
                                        ];
                                        ...
                                        foreach ($query_result_detail_capex_10->result_array() as $value_detail_capex_10) {
                                            ...
                                            $data_detail_capex_10 = [
                                                'nilai_capex_detail_10_add_XXV' => $value_detail_capex_10['nilai_capex_detail_10'],
                                            ];
...
$data_opex = [
    'nilai_opex_add_XXV' => $ambil_opex['nilai_opex'],
];
...
foreach ($ambil_opex_detail as $key => $value) {
    ...
    $data_opex_detail = [
        'nilai_detail_opex_add_XXV' => $value['nilai_detail_opex'],
    ];
...
foreach ($ambil_opex_detail as $key => $value_opex_detail) {
    ...
    foreach ($query_result_detail_opex_1->result_array() as $value_detail_opex_1) {
        ...
        $data_detail_opex_1 = [
            'nilai_opex_detail_1_add_XXV' => $value_detail_opex_1['nilai_opex_detail_1'],
        ];
        ...
        foreach ($query_result_detail_opex_2->result_array() as $value_detail_opex_2) {
            ...
            $data_detail_opex_2 = [
                'nilai_opex_detail_2_add_XXV' => $value_detail_opex_2['nilai_opex_detail_2'],
            ];
            ...
            foreach ($query_result_detail_opex_3->result_array() as $value_detail_opex_3) {
                ...
                $data_detail_opex_3 = [
                    'nilai_opex_detail_3_add_XXV' => $value_detail_opex_3['nilai_opex_detail_3'],
                ];
                ...
                foreach ($query_result_detail_opex_4->result_array() as $value_detail_opex_4) {
                    ...
                    $data_detail_opex_4 = [
                        'nilai_opex_detail_4_add_XXV' => $value_detail_opex_4['nilai_opex_detail_4'],
                    ];
                    ...
                    foreach ($query_result_detail_opex_5->result_array() as $value_detail_opex_5) {
                        ...
                        $data_detail_opex_5 = [
                            'nilai_opex_detail_5_add_XXV' => $value_detail_opex_5['nilai_opex_detail_5'],
                        ];
                        ...
                        foreach ($query_result_detail_opex_6->result_array() as $value_detail_opex_6) {
                            ...
                            $data_detail_opex_6 = [
                                'nilai_opex_detail_6_add_XXV' => $value_detail_opex_6['nilai_opex_detail_6'],
                            ];
                            ...
                            foreach ($query_result_detail_opex_7->result_array() as $value_detail_opex_7) {
                                ...
                                $data_detail_opex_7 = [
                                    'nilai_opex_detail_7_add_XXV' => $value_detail_opex_7['nilai_opex_detail_7'],
                                ];
                                ...
                                foreach ($query_result_detail_opex_8->result_array() as $value_detail_opex_8) {
                                    ...
                                    $data_detail_opex_8 = [
                                        'nilai_opex_detail_8_add_XXV' => $value_detail_opex_8['nilai_opex_detail_8'],
                                    ];
                                    ...
                                    foreach ($query_result_detail_opex_9->result_array() as $value_detail_opex_9) {
                                        ...
                                        $data_detail_opex_9 = [
                                            'nilai_opex_detail_9_add_XXV' => $value_detail_opex_9['nilai_opex_detail_9'],
                                        ];
                                        ...
                                        foreach ($query_result_detail_opex_10->result_array() as $value_detail_opex_10) {
                                            ...
                                            $data_detail_opex_10 = [
                                                'nilai_opex_detail_10_add_XXV' => $value_detail_opex_10['nilai_opex_detail_10'],
                                            ];
...
$data_bua = [
    'nilai_bua_add_XXV' => $ambil_bua['nilai_bua'],
...
foreach ($ambil_bua_detail as $key => $value) {
    ...
    $data_bua_detail = [
        'nilai_detail_bua_add_XXV' => $value['nilai_detail_bua'],
...
foreach ($ambil_bua_detail as $key => $value_bua_detail) {
    ...
    foreach ($query_result_detail_bua_1->result_array() as $value_detail_bua_1) {
        ...
        $data_detail_bua_1 = [
            'nilai_bua_detail_1_add_XXV' => $value_detail_bua_1['nilai_bua_detail_1'],
        ...
        foreach ($query_result_detail_bua_2->result_array() as $value_detail_bua_2) {
            ...
            $data_detail_bua_2 = [
                'nilai_bua_detail_2_add_XXV' => $value_detail_bua_2['nilai_bua_detail_2'],
            ...
            foreach ($query_result_detail_bua_3->result_array() as $value_detail_bua_3) {
                ...
                $data_detail_bua_3 = [
                    'nilai_bua_detail_3_add_XXV' => $value_detail_bua_3['nilai_bua_detail_3'],
                ...
                foreach ($query_result_detail_bua_4->result_array() as $value_detail_bua_4) {
                    ...
                    $data_detail_bua_4 = [
                        'nilai_bua_detail_4_add_XXV' => $value_detail_bua_4['nilai_bua_detail_4'],
                    ...
                    foreach ($query_result_detail_bua_5->result_array() as $value_detail_bua_5) {
                        ...
                        $data_detail_bua_5 = [
                            'nilai_bua_detail_5_add_XXV' => $value_detail_bua_5['nilai_bua_detail_5'],
                        ...
                        foreach ($query_result_detail_bua_6->result_array() as $value_detail_bua_6) {
                            ...
                            $data_detail_bua_6 = [
                                'nilai_bua_detail_6_add_XXV' => $value_detail_bua_6['nilai_bua_detail_6'],
                            ...
                            foreach ($query_result_detail_bua_7->result_array() as $value_detail_bua_7) {
                                ...
                                $data_detail_bua_7 = [
                                    'nilai_bua_detail_7_add_XXV' => $value_detail_bua_7['nilai_bua_detail_7'],
                                ...
                                foreach ($query_result_detail_bua_8->result_array() as $value_detail_bua_8) {
                                    ...
                                    $data_detail_bua_8 = [
                                        'nilai_bua_detail_8_add_XXV' => $value_detail_bua_8['nilai_bua_detail_8'],
                                    ...
                                    foreach ($query_result_detail_bua_9->result_array() as $value_detail_bua_9) {
                                        ...
                                        $data_detail_bua_9 = [
                                            'nilai_bua_detail_9_add_XXV' => $value_detail_bua_9['nilai_bua_detail_9'],
                                        ...
                                        foreach ($query_result_detail_bua_10->result_array() as $value_detail_bua_10) {
                                            ...
                                            $data_detail_bua_10 = [
                                                'nilai_bua_detail_10_add_XXV' => $value_detail_bua_10['nilai_bua_detail_10'],
...
$data_sdm = [
    'nilai_sdm_add_XXV' => $ambil_sdm['nilai_sdm'],
...
foreach ($ambil_sdm_detail as $key => $value) {
    ...
    $data_sdm_detail = [
        'nilai_detail_sdm_add_XXV' => $value['nilai_detail_sdm'],
...
foreach ($ambil_sdm_detail as $key => $value_sdm_detail) {
    ...
    foreach ($query_result_detail_sdm_1->result_array() as $value_detail_sdm_1) {
        ...
        $data_detail_sdm_1 = [
            'nilai_sdm_detail_1_add_XXV' => $value_detail_sdm_1['nilai_sdm_detail_1'],
        ...
        foreach ($query_result_detail_sdm_2->result_array() as $value_detail_sdm_2) {
            ...
            $data_detail_sdm_2 = [
                'nilai_sdm_detail_2_add_XXV' => $value_detail_sdm_2['nilai_sdm_detail_2'],
            ...
            foreach ($query_result_detail_sdm_3->result_array() as $value_detail_sdm_3) {
                ...
                $data_detail_sdm_3 = [
                    'nilai_sdm_detail_3_add_XXV' => $value_detail_sdm_3['nilai_sdm_detail_3'],
                ...
                foreach ($query_result_detail_sdm_4->result_array() as $value_detail_sdm_4) {
                    ...
                    $data_detail_sdm_4 = [
                        'nilai_sdm_detail_4_add_XXV' => $value_detail_sdm_4['nilai_sdm_detail_4'],
                    ...
                    foreach ($query_result_detail_sdm_5->result_array() as $value_detail_sdm_5) {
                        ...
                        $data_detail_sdm_5 = [
                            'nilai_sdm_detail_5_add_XXV' => $value_detail_sdm_5['nilai_sdm_detail_5'],
                        ...
                        foreach ($query_result_detail_sdm_6->result_array() as $value_detail_sdm_6) {
                            ...
                            $data_detail_sdm_6 = [
                                'nilai_sdm_detail_6_add_XXV' => $value_detail_sdm_6['nilai_sdm_detail_6'],
                            ...
                            foreach ($query_result_detail_sdm_7->result_array() as $value_detail_sdm_7) {
                                ...
                                $data_detail_sdm_7 = [
                                    'nilai_sdm_detail_7_add_XXV' => $value_detail_sdm_7['nilai_sdm_detail_7'],
                                ...
                                foreach ($query_result_detail_sdm_8->result_array() as $value_detail_sdm_8) {
                                    ...
                                    $data_detail_sdm_8 = [
                                        'nilai_sdm_detail_8_add_XXV' => $value_detail_sdm_8['nilai_sdm_detail_8'],
                                    ...
                                    foreach ($query_result_detail_sdm_9->result_array() as $value_detail_sdm_9) {
                                        ...
                                        $data_detail_sdm_9 = [
                                            'nilai_sdm_detail_9_add_XXV' => $value_detail_sdm_9['nilai_sdm_detail_9'],
                                        ...
                                        foreach ($query_result_detail_sdm_10->result_array() as $value_detail_sdm_10) {
                                            ...
                                            $data_detail_sdm_10 = [
                                                'nilai_sdm_detail_10_add_XXV' => $value_detail_sdm_10['nilai_sdm_detail_10'],
                                            ];
