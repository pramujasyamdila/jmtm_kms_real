        ...
        <div class="card" style="margin-top: 20px; padding: 20px;margin-top:-20px;font-family: 'Poppins', sans-serif;">
            <center>
                ...
                <div class="row" style="margin-left: 90px;">
                    ...
                    <div class="col-md-2">
                        <a class="btn text-white bg-success" style="width: 150px;height:50px;font-size:20px;">1</a>
                    </div>
                    <div class=" col-md-3">
                        <a class="btn text-white bg-success" style="width: 250px;height:50px;font-size:20px;">1</a>
                    </div>
                </div>
            </center>
        </div>
