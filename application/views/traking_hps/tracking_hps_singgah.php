...
<div class="main-content">
  ...
  position: fixed; top:50px;  padding-bottom: -10px;">
            <span style="margin-left: auto; font-weight:bold;""><b href=" <?= base_url('admin/data_kontrak_penyedia_jasa/') ?>">Tracking HPS</b> </span>
        </nav>
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <form action="<?= base_url('traking_hps/traking_hps/search') ?>" method="post">
                                                                <div class="col-md-12">
                                                                    ...
                                                                    <select name="uraian" class="form-control form-control-sm select2">
