...
if ($type_add) {
    ...
    $get_row_hps_penyedia_kontrak_4 = $this->Data_kontrak_model->get_hps_penyedia_kontrak_5($id_hps_penyedia_kontrak_5);
    $id_hps_penyedia_kontrak_4 = $get_row_hps_penyedia_kontrak_4['id_hps_penyedia_kontrak_4'];
    $total_harga_hps_penyedia_kontrak_4 = 0;
    $get_total_harga_hps_penyedia_kontrak_4 = $this->Data_kontrak_model->get_hps_penyedia_kontrak_4_result_total_harga($id_hps_penyedia_kontrak_4);
    foreach ($get_total_harga_hps_penyedia_kontrak_4 as $key => $value_hps_penyedia_kontrak_4) {
        if ($value_hps_penyedia_kontrak_4['total_harga_addendum_' . $type_add . ''] == 0 || $value_hps_penyedia_kontrak_4['total_harga_addendum_' . $type_add . ''] == null) {
            $total_harga_hps_penyedia_kontrak_4 += 0;
        } else {
            $total_harga_hps_penyedia_kontrak_4 += $value_hps_penyedia_kontrak_4['total_harga_addendum_' . $type_add . ''];
        }
    };
    ...
    $data_hps_penyedia_kontrak_4 = [
        'total_harga_addendum_' . $type_add . '' => $total_harga_hps_penyedia_kontrak_4,
    ];
    ...
    $get_row_hps_penyedia_kontrak_3 = $this->Data_kontrak_model->get_hps_penyedia_kontrak_4($id_hps_penyedia_kontrak_4);
    $id_hps_penyedia_kontrak_3 = $get_row_hps_penyedia_kontrak_3['id_hps_penyedia_kontrak_3'];
    $total_harga_hps_penyedia_kontrak_4 = 0;
    $get_total_harga_hps_penyedia_kontrak_4 = $this->Data_kontrak_model->get_hps_penyedia_kontrak_4_result_total_harga($id_hps_penyedia_kontrak_3);
    foreach ($get_total_harga_hps_penyedia_kontrak_4 as $key => $value_hps_penyedia_kontrak_4) {
        if ($value_hps_penyedia_kontrak_4['total_harga_addendum_' . $type_add . ''] == 0 || $value_hps_penyedia_kontrak_4['total_harga_addendum_' . $type_add . ''] == null) {
            $total_harga_hps_penyedia_kontrak_4 += 0;
        } else {
