        ...
        if ($type_add == '1') {
            ...
            $data = [
                'nilai_bua_detail_7_add_I' => $this->input->post('nilai_bua_detail_7'),
            ];
            ...
            $data = [
                'nilai_bua_detail_7_add_II' => $this->input->post('nilai_bua_detail_7'),
            ];
            $this->Data_kontrak_model->update_tbl_detail_bua_7($where, $data);
            $row_bua_detail_7 = $this->Data_kontrak_model->by_id_detail_bua_7($id_detail_bua_7);
            $id_detail_bua_6 = $row_bua_detail_7['id_detail_bua_6'];
            ...
            $data = [
                'nilai_bua_detail_7_add_III' => $this->input->post('nilai_bua_detail_7'),
            ];
            $this->Data_kontrak_model->update_tbl_detail_bua_7($where, $data);
            $row_bua_detail_7 = $this->Data_kontrak_model->by_id_detail_bua_7($id_detail_bua_7);
            $id_detail_bua_6 = $row_bua_detail_7['id_detail_bua_6'];
            ...
            $data = [
                'nilai_bua_detail_7_add_IV' => $this->input->post('nilai_bua_detail_7'),
            ];
            $this->Data_kontrak_model->update_tbl_detail_bua_7($where, $data);
            $row_bua_detail_7 = $this->Data_kontrak_model->by_id_detail_bua_7($id_detail_bua_7);
            $id_detail_bua_6 = $row_bua_detail_7['id_detail_bua_6'];
            ...
            $data = [
                'nilai_bua_detail_7_add_V' => $this->input->post('nilai_bua_detail_7'),
            ];
            $this->Data_kontrak_model->update_tbl_detail_bua_7($where, $data);
            $row_bua_detail_7 = $this->Data_kontrak_model->by_id_detail_bua_7($id_detail_bua_7);
            $id_detail_bua_6 = $row_bua_detail_7['id_detail_bua_6'];
            ...
            $data = [
                'nilai_bua_detail_7_add_VI' => $this->input->post('nilai_bua_detail_7'),
            ];
            $this->Data_kontrak_model->update_tbl_detail_bua_7($where, $data);
            $row_bua_detail_7 = $this->Data_kontrak_model->by_id_detail_bua_7($id_detail_bua_7);
            $id_detail_bua_6 = $row_bua_detail_7['id_detail_bua_6'];
            ...
            $data = [
                'nilai_bua_detail_7_add_VII' => $this->input->post('nilai_bua_detail_7'),
            ];
            $this->Data_kontrak_model->update_tbl_detail_bua_7($where, $data);
            $row_bua_detail_7 = $this->Data_kontrak_model->by_id_detail_bua_7($id_detail_bua_7);
            $id_detail_bua_6 = $row_bua_detail_7['id_detail_bua_6'];
            ...
            $data = [
                'nilai_bua_detail_7_add_VIII' => $this->input->post('nilai_bua_detail_7'),
            ];
            $this->Data_kontrak_model->update_tbl_detail_bua_7($where, $data);
            $row_bua_detail_7 = $this->Data_kontrak_model->by_id_detail_bua_7($id_detail_bua_7);
            $id_detail_bua_6 = $row_bua_detail_7['id_detail_bua_6'];
            ...
            $data = [
                'nilai_bua_detail_7_add_IX' => $this->input->post('nilai_bua_detail_7'),
            ];
            $this->Data_kontrak_model->update_tbl_detail_bua_7($where, $data);
            $row_bua_detail_7 = $this->Data_kontrak_model->by_id_detail_bua_7($id_detail_bua_7);
            $id_detail_bua_6 = $row_bua_detail_7['id_detail_bua_6'];
            ...
            $data = [
                'nilai_bua_detail_7_add_XI' => $this->input->post('nilai_bua_detail_7'),
            ];
            $this->Data_kontrak_model->update_tbl_detail_bua_7($where, $data);
            $row_bua_detail_7 = $this->Data_kontrak_model->by_id_detail_bua_7($id_detail_bua_7);
            $id_detail_bua_6 = $row_bua_detail_7['id_detail_bua_6'];
            ...
            $data = [
                'nilai_bua_detail_7_add_XII' => $this->input->post('nilai_bua_detail_7'),
            ];
            $this->Data_kontrak_model->update_tbl_detail_bua_7($where, $data);
            $row_bua_detail_7 = $this->Data_kontrak_model->by_id_detail_bua_7($id_detail_bua_7);
            $id_detail_bua_6 = $row_bua_detail_7['id_detail_bua_6'];
            ...
            $data = [
                'nilai_bua_detail_7_add_XIII' => $this->input->post('nilai_bua_detail_7'),
            ];
            $this->Data_kontrak_model->update_tbl_detail_bua_7($where, $data);
            $row_bua_detail_7 = $this->Data_kontrak_model->by_id_detail_bua_7($id_detail_bua_7);
            $id_detail_bua_6 = $row_bua_detail_7['id_detail_bua_6'];
            ...
            $data = [
                'nilai_bua_detail_7_add_XIV' => $this->input->post('nilai_bua_detail_7'),
            ];
            $this->Data_kontrak_model->update_tbl_detail_bua_7($where, $data);
            $row_bua_detail_7 = $this->Data_kontrak_model->by_id_detail_bua_7($id_detail_bua_7);
            $id_detail_bua_6 = $row_bua_detail_7['id_detail_bua_6'];
            ...
            $data = [
                'nilai_bua_detail_7_add_XV' => $this->input->post('nilai_bua_detail_7'),
            ];
            $this->Data_kontrak_model->update_tbl_detail_bua_7($where, $data);
            $row_bua_detail_7 = $this->Data_kontrak_model->by_id_detail_bua_7($id_detail_bua_7);
            $id_detail_bua_6 = $row_bua_detail_7['id_detail_bua_6'];
            ...
            $data = [
                'nilai_bua_detail_7_add_XVI' => $this->input->post('nilai_bua_detail_7'),
            ];
            $this->Data_kontrak_model->update_tbl_detail_bua_7($where, $data);
            $row_bua_detail_7 = $this->Data_kontrak_model->by_id_detail_bua_7($id_detail_bua_7);
            $id_detail_bua_6 = $row_bua_detail_7['id_detail_bua_6'];
            ...
            $data = [
                'nilai_bua_detail_7_add_XVII' => $this->input->post('nilai_bua_detail_7'),
            ];
            $this->Data_kontrak_model->update_tbl_detail_bua_7($where, $data);
            $row_bua_detail_7 = $this->Data_kontrak_model->by_id_detail_bua_7($id_detail_bua_7);
            $id_detail_bua_6 = $row_bua_detail_7['id_detail_bua_6'];
            ...
            $data = [
                'nilai_bua_detail_7_add_XVIII' => $this->input->post('nilai_bua_detail_7'),
            ];
            $this->Data_kontrak_model->update_tbl_detail_bua_7($where, $data);
            $row_bua_detail_7 = $this->Data_kontrak_model->by_id_detail_bua_7($id_detail_bua_7);
            $id_detail_bua_6 = $row_bua_detail_7['id_detail_bua_6'];
            ...
            $data = [
                'nilai_bua_detail_7_add_XIX' => $this->input->post('nilai_bua_detail_7'),
            ];
            $this->Data_kontrak_model->update_tbl_detail_bua_7($where, $data);
            $row_bua_detail_7 = $this->Data_kontrak_model->by_id_detail_bua_7($id_detail_bua_7);
            $id_detail_bua_6 = $row_bua_detail_7['id_detail_bua_6'];
            ...
            $data = [
                'nilai_bua_detail_7_add_XX' => $this->input->post('nilai_bua_detail_7'),
            ];
            $this->Data_kontrak_model->update_tbl_detail_bua_7($where, $data);
            $row_bua_detail_7 = $this->Data_kontrak_model->by_id_detail_bua_7($id_detail_bua_7);
            $id_detail_bua_6 = $row_bua_detail_7['id_detail_bua_6'];
            ...
            $data = [
                'nilai_bua_detail_7_add_XXI' => $this->input->post('nilai_bua_detail_7'),
            ];
            $this->Data_kontrak_model->update_tbl_detail_bua_7($where, $data);
            $row_bua_detail_7 = $this->Data_kontrak_model->by_id_detail_bua_7($id_detail_bua_7);
            $id_detail_bua_6 = $row_bua_detail_7['id_detail_bua_6'];
            ...
            $data = [
                'nilai_bua_detail_7_add_XXII' => $this->input->post('nilai_bua_detail_7'),
            ];
            $this->Data_kontrak_model->update_tbl_detail_bua_7($where, $data);
            $row_bua_detail_7 = $this->Data_kontrak_model->by_id_detail_bua_7($id_detail_bua_7);
            $id_detail_bua_6 = $row_bua_detail_7['id_detail_bua_6'];
            ...
            $data = [
                'nilai_bua_detail_7_add_XXIII' => $this->input->post('nilai_bua_detail_7'),
            ];
            $this->Data_kontrak_model->update_tbl_detail_bua_7($where, $data);
            $row_bua_detail_7 = $this->Data_kontrak_model->by_id_detail_bua_7($id_detail_bua_7);
            $id_detail_bua_6 = $row_bua_detail_7['id_detail_bua_6'];
            ...
            $data = [
                'nilai_bua_detail_7_add_XXIV' => $this->input->post('nilai_bua_detail_7'),
            ];
            $this->Data_kontrak_model->update_tbl_detail_bua_7($where, $data);
            $row_bua_detail_7 = $this->Data_kontrak_model->by_id_detail_bua_7($id_detail_bua_7);
            $id_detail_bua_6 = $row_bua_detail_7['id_detail_bua_6'];
            ...
            $data = [
                'nilai_bua_detail_7_add_XXV' => $this->input->post('nilai_bua_detail_7'),
            ];
            $this->Data_kontrak_model->update_tbl_detail_bua_7($where, $data);
            $row_bua_detail_7 = $this->Data_kontrak_model->by_id_detail_bua_7($id_detail_bua_7);
            $id_detail_bua_6 = $row_bua_detail_7['id_detail_bua_6'];
            ...
            $data = [
                'nilai_bua_detail_7_add_XXVI' => $this->input->post('nilai_bua_detail_7'),
            ];
            $this->Data_kontrak_model->update_tbl_detail_bua_7($where, $data);
            $row_bua_detail_7 = $this->Data_kontrak_model->by_id_detail_bua_7($id_detail_bua_7);
            $id_detail_bua_6 = $row_bua_detail_7['id_detail_bua_6'];
            ...
            $data = [
                'nilai_bua_detail_7_add_XXVII' => $this->input->post('nilai_bua_detail_7'),
            ];
            $this->Data_kontrak_model->update_tbl_detail_bua_7($where, $data);
            $row_bua_detail_7 = $this->Data_kontrak_model->by_id_detail_bua_7($id_detail_bua_7);
            $id_detail_bua_6 = $row_bua_detail_7['id_detail_bua_6'];
            ...
            $data = [
                'nilai_bua_detail_7_add_XXVIII' => $this->input->post('nilai_bua_detail_7'),
            ];
            $this->Data_kontrak_model->update_tbl_detail_bua_7($where, $data);
            $row_bua_detail_7 = $this->Data_kontrak_model->by_id_detail_bua_7($id_detail_bua_7);
            $id_detail_bua_6 = $row_bua_detail_7['id_detail_bua_6'];
            ...
            $data = [
                'nilai_bua_detail_7_add_XXIX' => $this->input->post('nilai_bua_detail_7'),
            ];
            $this->Data_kontrak_model->update_tbl_detail_bua_7($where, $data);
            $row_bua_detail_7 = $this->Data_kontrak_model->by_id_detail_bua_7($id_detail_bua_7);
            $id_detail_bua_6 = $row_bua_detail_7['id_detail_bua_6'];
            ...
            $data = [
                'nilai_bua_detail_7_add_XXX' => $this->input->post('nilai_bua_detail_7'),
            ];
            $this->Data_kontrak_model->update_tbl_detail_bua_7($where, $data);
            $row_bua_detail_7 = $this->Data_kontrak_model->by_id_detail_bua_7($id_detail_bua_7);
            $id_detail_bua_6 = $row_bua_detail_7['id_detail_bua_6'];
            ...
            $data = [
                'nilai_bua_detail_7' => $this->input->post('nilai_bua_detail_7'),
            ];
            $this->Data_kontrak_model->update_tbl_detail_bua_7($where, $data);
            $row_bua_detail_7 = $this->Data_kontrak_model->by_id_detail_bua_7($id_detail_bua_7);
            $id_detail_bua_6 = $row_bua_detail_7['id_detail_bua_6'];
