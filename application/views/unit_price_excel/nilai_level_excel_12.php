...
$total_unit_price_10 = 0;
foreach ($query_d as $key => $value_unit_price_10) {
    $total_unit_price_10 +=  $value_unit_price_10['total_harga'];
};
$where = [
    'id_unit_price_9' => $id_unit_price_9
];
$data = [
    'total_harga' => $total_unit_price_10,
];
$this->Data_kontrak_model->update_tbl_unit_price_9($where, $data);
$row_unit_price_9 = $this->Data_kontrak_model->by_id_unit_price_9($id_unit_price_9);
$id_unit_price_7 = $row_unit_price_9['id_unit_price_7'];
...
foreach ($query_d as $key => $value_unit_price_9) {
    $total_unit_price_9 +=  $value_unit_price_9['total_harga'];
};
$where = [
    'id_unit_price_8' => $id_unit_price_8
];
$data = [
    'total_harga' => $total_unit_price_9,
];
$this->Data_kontrak_model->update_tbl_unit_price_8($where, $data);
...
$query_d = $this->db->get()->result_array();
$total_unit_price_8 = 0;
foreach ($query_d as $key => $value_unit_price_8) {
    $total_unit_price_8 +=  $value_unit_price_8['total_harga'];
};
$where = [
    'id_unit_price_7' => $id_unit_price_7
];
$data = [
    'total_harga' => $total_unit_price_8,
];
$this->Data_kontrak_model->update_tbl_unit_price_7($where, $data);
...
$query_d = $this->db->get()->result_array();
$total_unit_price_7 = 0;
foreach ($query_d as $key => $value_unit_price_7) {
    $total_unit_price_7 +=  $value_unit_price_7['total_harga'];
};
$where = [
    'id_unit_price_6' => $id_unit_price_6
];
$data = [
    'total_harga' => $total_unit_price_7,
];
$this->Data_kontrak_model->update_tbl_unit_price_6($where, $data);
...
$query_d = $this->db->get()->result_array();
$total_unit_price_6 = 0;
foreach ($query_d as $key => $value_unit_price_6) {
    $total_unit_price_6 +=  $value_unit_price_6['total_harga'];
};
$where = [
    'id_unit_price_5' => $id_unit_price_5
];
$data = [
    'total_harga' => $total_unit_price_6,
];
$this->Data_kontrak_model->update_tbl_unit_price_5($where, $data);
