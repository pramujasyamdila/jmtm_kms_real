...
if ($type_add == '1') {
    ...
    $data = [
        'nilai_detail_opex_add_I' => $this->input->post('nilai_detail_opex'),
    ];
    ...
    $data = [
        'nilai_detail_opex_add_II' => $this->input->post('nilai_detail_opex'),
    ];
    $this->Data_kontrak_model->update_tbl_opex_detail($where, $data);
    $row_opex_detail = $this->Data_kontrak_model->by_id_opex_detail($id_opex_detail);
    $id_opex = $row_opex_detail['id_opex'];
    ...
    $data = [
        'nilai_detail_opex_add_III' => $this->input->post('nilai_detail_opex'),
    ];
    $this->Data_kontrak_model->update_tbl_opex_detail($where, $data);
    $row_opex_detail = $this->Data_kontrak_model->by_id_opex_detail($id_opex_detail);
    $id_opex = $row_opex_detail['id_opex'];
    ...
    $data = [
        'nilai_detail_opex_add_IV' => $this->input->post('nilai_detail_opex'),
    ];
    $this->Data_kontrak_model->update_tbl_opex_detail($where, $data);
    $row_opex_detail = $this->Data_kontrak_model->by_id_opex_detail($id_opex_detail);
    $id_opex = $row_opex_detail['id_opex'];
    ...
    $data = [
        'nilai_detail_opex_add_V' => $this->input->post('nilai_detail_opex'),
    ];
    $this->Data_kontrak_model->update_tbl_opex_detail($where, $data);
    $row_opex_detail = $this->Data_kontrak_model->by_id_opex_detail($id_opex_detail);
    $id_opex = $row_opex_detail['id_opex'];
    ...
    $data = [
        'nilai_detail_opex_add_VI' => $this->input->post('nilai_detail_opex'),
    ];
    $this->Data_kontrak_model->update_tbl_opex_detail($where, $data);
    $row_opex_detail = $this->Data_kontrak_model->by_id_opex_detail($id_opex_detail);
    $id_opex = $row_opex_detail['id_opex'];
    ...
    $data = [
        'nilai_detail_opex_add_VII' => $this->input->post('nilai_detail_opex'),
    ];
    $this->Data_kontrak_model->update_tbl_opex_detail($where, $data);
    $row_opex_detail = $this->Data_kontrak_model->by_id_opex_detail($id_opex_detail);
    $id_opex = $row_opex_detail['id_opex'];
    ...
    $data = [
        'nilai_detail_opex_add_VIII' => $this->input->post('nilai_detail_opex'),
    ];
    $this->Data_kontrak_model->update_tbl_opex_detail($where, $data);
    $row_opex_detail = $this->Data_kontrak_model->by_id_opex_detail($id_opex_detail);
    $id_opex = $row_opex_detail['id_opex'];
    ...
    $data = [
        'nilai_detail_opex_add_IX' => $this->input->post('nilai_detail_opex'),
    ];
    $this->Data_kontrak_model->update_tbl_opex_detail($where, $data);
    $row_opex_detail = $this->Data_kontrak_model->by_id_opex_detail($id_opex_detail);
    $id_opex = $row_opex_detail['id_opex'];
    ...
    $data = [
        'nilai_detail_opex_add_X' => $this->input->post('nilai_detail_opex'),
    ];
    $this->Data_kontrak_model->update_tbl_opex_detail($where, $data);
    $row_opex_detail = $this->Data_kontrak_model->by_id_opex_detail($id_opex_detail);
    $id_opex = $row_opex_detail['id_opex'];
    ...
    $data = [
        'nilai_detail_opex_add_XI' => $this->input->post('nilai_detail_opex'),
    ];
    $this->Data_kontrak_model->update_tbl_opex_detail($where, $data);
    $row_opex_detail = $this->Data_kontrak_model->by_id_opex_detail($id_opex_detail);
    $id_opex = $row_opex_detail['id_opex'];
    ...
    $data = [
        'nilai_detail_opex_add_XII' => $this->input->post('nilai_detail_opex'),
    ];
    $this->Data_kontrak_model->update_tbl_opex_detail($where, $data);
    $row_opex_detail = $this->Data_kontrak_model->by_id_opex_detail($id_opex_detail);
    $id_opex = $row_opex_detail['id_opex'];
    ...
    $data = [
        'nilai_detail_opex_add_XIII' => $this->input->post('nilai_detail_opex'),
    ];
    $this->Data_kontrak_model->update_tbl_opex_detail($where, $data);
    $row_opex_detail = $this->Data_kontrak_model->by_id_opex_detail($id_opex_detail);
    $id_opex = $row_opex_detail['id_opex'];
    ...
    $data = [
        'nilai_detail_opex_add_XIV' => $this->input->post('nilai_detail_opex'),
    ];
    $this->Data_kontrak_model->update_tbl_opex_detail($where, $data);
    $row_opex_detail = $this->Data_kontrak_model->by_id_opex_detail($id_opex_detail);
    $id_opex = $row_opex_detail['id_opex'];
    ...
    $data = [
        'nilai_detail_opex_add_XV' => $this->input->post('nilai_detail_opex'),
    ];
    $this->Data_kontrak_model->update_tbl_opex_detail($where, $data);
    $row_opex_detail = $this->Data_kontrak_model->by_id_opex_detail($id_opex_detail);
    $id_opex = $row_opex_detail['id_opex'];
    ...
    $data = [
        'nilai_detail_opex_add_XVI' => $this->input->post('nilai_detail_opex'),
    ];
    $this->Data_kontrak_model->update_tbl_opex_detail($where, $data);
    $row_opex_detail = $this->Data_kontrak_model->by_id_opex_detail($id_opex_detail);
    $id_opex = $row_opex_detail['id_opex'];
    ...
    $data = [
        'nilai_detail_opex_add_XVII' => $this->input->post('nilai_detail_opex'),
    ];
    $this->Data_kontrak_model->update_tbl_opex_detail($where, $data);
    $row_opex_detail = $this->Data_kontrak_model->by_id_opex_detail($id_opex_detail);
    $id_opex = $row_opex_detail['id_opex'];
    ...
    $data = [
        'nilai_detail_opex_add_XVIII' => $this->input->post('nilai_detail_opex'),
    ];
    $this->Data_kontrak_model->update_tbl_opex_detail($where, $data);
    $row_opex_detail = $this->Data_kontrak_model->by_id_opex_detail($id_opex_detail);
    $id_opex = $row_opex_detail['id_opex'];
    ...
    $data = [
        'nilai_detail_opex_add_XIX' => $this->input->post('nilai_detail_opex'),
    ];
    $this->Data_kontrak_model->update_tbl_opex_detail($where, $data);
    $row_opex_detail = $this->Data_kontrak_model->by_id_opex_detail($id_opex_detail);
    $id_opex = $row_opex_detail['id_opex'];
    ...
    $data = [
        'nilai_detail_opex_add_XX' => $this->input->post('nilai_detail_opex'),
    ];
    $this->Data_kontrak_model->update_tbl_opex_detail($where, $data);
    $row_opex_detail = $this->Data_kontrak_model->by_id_opex_detail($id_opex_detail);
    $id_opex = $row_opex_detail['id_opex'];
    ...
    $data = [
        'nilai_detail_opex_add_XXI' => $this->input->post('nilai_detail_opex'),
    ];
    $this->Data_kontrak_model->update_tbl_opex_detail($where, $data);
    $row_opex_detail = $this->Data_kontrak_model->by_id_opex_detail($id_opex_detail);
    $id_opex = $row_opex_detail['id_opex'];
    ...
    $data = [
        'nilai_detail_opex_add_XXII' => $this->input->post('nilai_detail_opex'),
    ];
    $this->Data_kontrak_model->update_tbl_opex_detail($where, $data);
    $row_opex_detail = $this->Data_kontrak_model->by_id_opex_detail($id_opex_detail);
    $id_opex = $row_opex_detail['id_opex'];
    ...
    $data = [
        'nilai_detail_opex_add_XXIII' => $this->input->post('nilai_detail_opex'),
    ];
    $this->Data_kontrak_model->update_tbl_opex_detail($where, $data);
    $row_opex_detail = $this->Data_kontrak_model->by_id_opex_detail($id_opex_detail);
    $id_opex = $row_opex_detail['id_opex'];
    ...
    $data = [
        'nilai_detail_opex_add_XXIV' => $this->input->post('nilai_detail_opex'),
    ];
    $this->Data_kontrak_model->update_tbl_opex_detail($where, $data);
    $row_opex_detail = $this->Data_kontrak_model->by_id_opex_detail($id_opex_detail);
    $id_opex = $row_opex_detail['id_opex'];
    ...
    $data = [
        'nilai_detail_opex_add_XXV' => $this->input->post('nilai_detail_opex'),
    ];
    $this->Data_kontrak_model->update_tbl_opex_detail($where, $data);
    $row_opex_detail = $this->Data_kontrak_model->by_id_opex_detail($id_opex_detail);
    $id_opex = $row_opex_detail['id_opex'];
    ...
    $data = [
        'nilai_detail_opex_add_XXVI' => $this->input->post('nilai_detail_opex'),
    ];
    $this->Data_kontrak_model->update_tbl_opex_detail($where, $data);
    $row_opex_detail = $this->Data_kontrak_model->by_id_opex_detail($id_opex_detail);
    $id_opex = $row_opex_detail['id_opex'];
    ...
    $data = [
        'nilai_detail_opex_add_XXVII' => $this->input->post('nilai_detail_opex'),
    ];
    $this->Data_kontrak_model->update_tbl_opex_detail($where, $data);
    $row_opex_detail = $this->Data_kontrak_model->by_id_opex_detail($id_opex_detail);
    $id_opex = $row_opex_detail['id_opex'];
    ...
    $data = [
        'nilai_detail_opex_add_XXVIII' => $this->input->post('nilai_detail_opex'),
    ];
    $this->Data_kontrak_model->update_tbl_opex_detail($where, $data);
    $row_opex_detail = $this->Data_kontrak_model->by_id_opex_detail($id_opex_detail);
    $id_opex = $row_opex_detail['id_opex'];
    ...
    $data = [
        'nilai_detail_opex_add_XXIX' => $this->input->post('nilai_detail_opex'),
    ];
    $this->Data_kontrak_model->update_tbl_opex_detail($where, $data);
    $row_opex_detail = $this->Data_kontrak_model->by_id_opex_detail($id_opex_detail);
    $id_opex = $row_opex_detail['id_opex'];
    ...
    $data = [
        'nilai_detail_opex_add_XXX' => $this->input->post('nilai_detail_opex'),
    ];
    $this->Data_kontrak_model->update_tbl_opex_detail($where, $data);
    $row_opex_detail = $this->Data_kontrak_model->by_id_opex_detail($id_opex_detail);
    $id_opex = $row_opex_detail['id_opex'];
