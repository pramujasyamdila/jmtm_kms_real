...
if ($type_add =='1') {
    ...
    $data = [
        'nilai_capex_add_I' => $this->input->post('nilai_capex'),
    ];
    ...
    $data = [
        'nilai_capex_add_II' => $this->input->post('nilai_capex'),
    ];
    $this->Data_kontrak_model->update_tbl_capex($where, $data);
    // update after
    $row_capex = $this->Data_kontrak_model->by_id_capex($id_capex);
    ...
    $data = [
        'nilai_capex_add_III' => $this->input->post('nilai_capex'),
    ];
    $this->Data_kontrak_model->update_tbl_capex($where, $data);
    // update after
    $row_capex = $this->Data_kontrak_model->by_id_capex($id_capex);
    ...
    $data = [
        'nilai_capex_add_IV' => $this->input->post('nilai_capex'),
    ];
    $this->Data_kontrak_model->update_tbl_capex($where, $data);
    // update after
    $row_capex = $this->Data_kontrak_model->by_id_capex($id_capex);
    ...
    $data = [
        'nilai_capex_add_V' => $this->input->post('nilai_capex'),
    ];
    $this->Data_kontrak_model->update_tbl_capex($where, $data);
    // update after
    $row_capex = $this->Data_kontrak_model->by_id_capex($id_capex);
    ...
    $data = [
        'nilai_capex_add_VI' => $this->input->post('nilai_capex'),
    ];
    $this->Data_kontrak_model->update_tbl_capex($where, $data);
    // update after
    $row_capex = $this->Data_kontrak_model->by_id_capex($id_capex);
    ...
    $data = [
        'nilai_capex_add_VII' => $this->input->post('nilai_capex'),
    ];
    $this->Data_kontrak_model->update_tbl_capex($where, $data);
    // update after
    $row_capex = $this->Data_kontrak_model->by_id_capex($id_capex);
    ...
    $data = [
        'nilai_capex_add_VIII' => $this->input->post('nilai_capex'),
    ];
    $this->Data_kontrak_model->update_tbl_capex($where, $data);
    // update after
    $row_capex = $this->Data_kontrak_model->by_id_capex($id_capex);
    ...
    $data = [
        'nilai_capex_add_IX' => $this->input->post('nilai_capex'),
    ];
    $this->Data_kontrak_model->update_tbl_capex($where, $data);
    // update after
    $row_capex = $this->Data_kontrak_model->by_id_capex($id_capex);
    ...
    $data = [
        'nilai_capex_add_X' => $this->input->post('nilai_capex'),
    ];
    $this->Data_kontrak_model->update_tbl_capex($where, $data);
    // update after
    $row_capex = $this->Data_kontrak_model->by_id_capex($id_capex);
    ...
    $data = [
        'nilai_capex_add_XI' => $this->input->post('nilai_capex'),
    ];
    $this->Data_kontrak_model->update_tbl_capex($where, $data);
    // update after
    $row_capex = $this->Data_kontrak_model->by_id_capex($id_capex);
    ...
    $data = [
        'nilai_capex_add_XII' => $this->input->post('nilai_capex'),
    ];
    $this->Data_kontrak_model->update_tbl_capex($where, $data);
    // update after
    $row_capex = $this->Data_kontrak_model->by_id_capex($id_capex);
    ...
    $data = [
        'nilai_capex_add_XIII' => $this->input->post('nilai_capex'),
    ];
    $this->Data_kontrak_model->update_tbl_capex($where, $data);
    // update after
    $row_capex = $this->Data_kontrak_model->by_id_capex($id_capex);
    ...
    $data = [
        'nilai_capex_add_XIV' => $this->input->post('nilai_capex'),
    ];
    $this->Data_kontrak_model->update_tbl_capex($where, $data);
    // update after
    $row_capex = $this->Data_kontrak_model->by_id_capex($id_capex);
    ...
    $data = [
        'nilai_capex_add_XV' => $this->input->post('nilai_capex'),
    ];
    $this->Data_kontrak_model->update_tbl_capex($where, $data);
    // update after
    $row_capex = $this->Data_kontrak_model->by_id_capex($id_capex);
    ...
    $data = [
        'nilai_capex_add_XVI' => $this->input->post('nilai_capex'),
    ];
    $this->Data_kontrak_model->update_tbl_capex($where, $data);
    // update after
    $row_capex = $this->Data_kontrak_model->by_id_capex($id_capex);
    ...
    $data = [
        'nilai_capex_add_XVII' => $this->input->post('nilai_capex'),
    ];
    $this->Data_kontrak_model->update_tbl_capex($where, $data);
    // update after
    $row_capex = $this->Data_kontrak_model->by_id_capex($id_capex);
    ...
    $data = [
        'nilai_capex_add_XVIII' => $this->input->post('nilai_capex'),
    ];
    $this->Data_kontrak_model->update_tbl_capex($where, $data);
    // update after
    $row_capex = $this->Data_kontrak_model->by_id_capex($id_capex);
    ...
    $data = [
        'nilai_capex_add_XIX' => $this->input->post('nilai_capex'),
    ];
    $this->Data_kontrak_model->update_tbl_capex($where, $data);
    // update after
    $row_capex = $this->Data_kontrak_model->by_id_capex($id_capex);
    ...
    $data = [
        'nilai_capex_add_XX' => $this->input->post('nilai_capex'),
    ];
    $this->Data_kontrak_model->update_tbl_capex($where, $data);
    // update after
    $row_capex = $this->Data_kontrak_model->by_id_capex($id_capex);
    ...
    $data = [
        'nilai_capex_add_XXI' => $this->input->post('nilai_capex'),
    ];
    $this->Data_kontrak_model->update_tbl_capex($where, $data);
    // update after
    $row_capex = $this->Data_kontrak_model->by_id_capex($id_capex);
    ...
    $data = [
        'nilai_capex_add_XXII' => $this->input->post('nilai_capex'),
    ];
    $this->Data_kontrak_model->update_tbl_capex($where, $data);
    // update after
    $row_capex = $this->Data_kontrak_model->by_id_capex($id_capex);
    ...
    $data = [
        'nilai_capex_add_XXIII' => $this->input->post('nilai_capex'),
    ];
    $this->Data_kontrak_model->update_tbl_capex($where, $data);
    // update after
    $row_capex = $this->Data_kontrak_model->by_id_capex($id_capex);
    ...
    $data = [
        'nilai_capex_add_XXIV' => $this->input->post('nilai_capex'),
    ];
    $this->Data_kontrak_model->update_tbl_capex($where, $data);
    // update after
    $row_capex = $this->Data_kontrak_model->by_id_capex($id_capex);
    ...
    $data = [
        'nilai_capex_add_XXV' => $this->input->post('nilai_capex'),
    ];
    $this->Data_kontrak_model->update_tbl_capex($where, $data);
    // update after
    $row_capex = $this->Data_kontrak_model->by_id_capex($id_capex);
    ...
    $data = [
        'nilai_capex_add_XXVI' => $this->input->post('nilai_capex'),
    ];
    $this->Data_kontrak_model->update_tbl_capex($where, $data);
    // update after
    $row_capex = $this->Data_kontrak_model->by_id_capex($id_capex);
    ...
    $data = [
        'nilai_capex_add_XXVII' => $this->input->post('nilai_capex'),
    ];
    $this->Data_kontrak_model->update_tbl_capex($where, $data);
    // update after
    $row_capex = $this->Data_kontrak_model->by_id_capex($id_capex);
    ...
    $data = [
        'nilai_capex_add_XXVIII' => $this->input->post('nilai_capex'),
    ];
    $this->Data_kontrak_model->update_tbl_capex($where, $data);
    // update after
    $row_capex = $this->Data_kontrak_model->by_id_capex($id_capex);
    ...
    $data = [
        'nilai_capex_add_XXIX' => $this->input->post('nilai_capex'),
    ];
    $this->Data_kontrak_model->update_tbl_capex($where, $data);
    // update after
    $row_capex = $this->Data_kontrak_model->by_id_capex($id_capex);
    ...
    $data = [
        'nilai_capex_add_XXX' => $this->input->post('nilai_capex'),
    ];
    $this->Data_kontrak_model->update_tbl_capex($where, $data);
    // update after
    $row_capex = $this->Data_kontrak_model->by_id_capex($id_capex);
