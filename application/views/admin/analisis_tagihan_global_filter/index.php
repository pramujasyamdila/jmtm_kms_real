                ...
                <div class="col-md-12">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <a class="btn btn-warning btn-lg" href="<?= base_url('admin/analisa_tagihan') ?>"> Lihat Keseluruhan Data Grafik <i class="fa fa-filter" aria-hidden="true"></i></a>
                            ...
                            <!-- Button trigger modal -->
                            <button type="button" title="Input Pendapatan <?= $row_kontrak['nama_kontrak'] ?>" class="btn btn-success btn-lg" data-toggle="modal" data-target="#tambah_pendaptan">
                                Input Pendapatan <i class="fa fa-tags" aria-hidden="true"></i>
                            </button>
                        </div>
                    </div>
                    <br>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <div class="card card-success">
                                                <div class="card-header">
                                                    <h3 class="card-title">Grafik Kontrak <?= $row_kontrak['nama_kontrak'] ?></h3>
                                                </div>
                                                <div class="card-body">
                                                    <div class="chart">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="javascript:;" id="form_pendaptan">
                    <input type="hidden" name="id_kontrak_cari_pendapatan" value="<?= $row_kontrak['id_kontrak'] ?>" aria-describedby="helpId">
                    <div class="container-fluid">
                        <div class="form-group">
