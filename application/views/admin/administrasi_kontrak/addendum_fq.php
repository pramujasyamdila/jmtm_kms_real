        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-md-12">
                            ...
                            <div class="card-header">
                                <div class="row">
                                    ...
                                    <div class="col-md-5 mt-4">
                                        <h5> <i class="fa fa-book"></i> ADDENDUM FINAL QUANTITY </h5>
                                    </div>
                                </div>
                            </div>
                            <div class="card-body">
                                <div class="card-header">
                                    Addendum FQ <?= $row_sub_program['nama_program_mata_anggaran'] ?>
                                </div>
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="card-body">
                                            ...
                                            <div class="float-right">
                                                ...
                                                <button type="button" class="btn btn-sm btn-outline-primary mb-3" data-toggle="modal" data-target="#buat_addendum_pq">
                                            ...
                                            <table id="tbl_addendum_fq" class="table table-striped table-bordered">
                                                <thead>
                                                    <tr class="bg-primary">
                                                        <th>No</th>
                                                        <th>No Addendum</th>
                    ...
                    <div class="modal fade" id="buat_addendum_pq" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <div class="container-fluid">
                                        <form action="javascript:;" id="form_addendum_kontrak_pq" method="post">
                                            <input type="hidden" name="id_detail_sub_program_penyedia_jasa" value="<?= $row_sub_program['id_detail_sub_program_penyedia_jasa'] ?>">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <a href="javascript:;" onclick="Simpan_addendum_pq()" class="btn btn-sm btn-outline-success"><i class="fa fa-paper-plane" aria-hidden="true"></i> Simpan</a>
                                </div>
                            </div>
                        </div>
                    </div>
