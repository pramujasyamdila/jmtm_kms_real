...
<div class="main-content">
    <section class="section">
        <div class="section-header">
            <h1><i class="fa fa-book"></i> DATA KONTRAK</h1>
            <div class="section-header-breadcrumb">
                <div class="breadcrumb-item active"><a href="<?= base_url('admin/administrasi_kontrak/pasca_pengadaan') ?>">DATA KONTRAK</a></div>
            </div>
        </div>
                            ...
                            <div class="col-sm-12">
                                <div class="card card-outline card-warning">
                                    <div class="card-header">
                                        <div class="row">
                                            <h5><i class="fas fa fa-search"></i> FILTER KONTRAK</h5>
                                        </div>
                                    </div>
                                    <div class="card-body">
                                        <div class="row">
