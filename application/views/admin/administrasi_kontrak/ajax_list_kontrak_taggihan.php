<script>
    ...
    function byid(id, type) {
        ...
        $.ajax({
            ...
            success: function(response) {
                if (type == 'lihat_program') {
                    window.location.href = "<?= base_url('administrasi_kontrak/administrasi_kontrak/list_program_taggihan/') ?>" + id
                }
            }
        })
    }
    ...
    function fill_datatable(id_departemen, id_area, id_sub_area) {
        tabledata.DataTable({
            ...
            "order": [],
            "ajax": {
                "url": "<?= base_url('admin/Administrasi_penyedia/get_data_taggihan') ?>",
                "type": "POST",
                data: {
