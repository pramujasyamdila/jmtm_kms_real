...
<head>
    <title>Permohonan Izin Prinsip GM ke DRIOPS</title>
    <meta charset="utf-8">
...
<body style="font-size: 13px;">
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-2">
                <label for="" style="margin-left: -90px;"> <?= $row_program_detail['tgl_surat_pip_gm_ke_dirops'] ?></label>
            </div>
        </div>
        <div class="row">
            <div class="col-md-1">
            ...
            <div class="col-md-4">
                <label for="" style="margin-left: -90px;">: <?= $row_program_detail['lampiran_pip_gm_ke_dirops'] ?></label>
            </div>
            <div class="col-md-2">
            </div>
            <div class="col-md-2">
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <center>
                    ...
                    <br>
                    <br><br><br><br>
                    <h5><u style="text-transform: capitalize;"><?= $row_program_detail['nama_gm_ke_dirops'] ?></u></h5>
                    <h5>General Manager
                    </h5>
