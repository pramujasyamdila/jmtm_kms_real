...
<body style="font-size: 13px;">
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-2">
                <label><?= $this->jam_tgl->tgl_indo($row_program_detail['tgl_surat_pip_gm_ke_dirops']) ?></label>
            </div>
        </div>
        <div class="row">
            <div class="col-md-1">
        ...
        <div class="mt-5">
            Yth.
            <br>
            <b> <label for=""><?= $row_program_detail['jabatan_penerima_pip_gm_ke_dirops'] ?></label></b> <br>
