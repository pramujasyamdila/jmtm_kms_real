...
<div class="main-content">
    <section class="section">
        <div class="section-header">
            <h1><i class="fa fa-book"></i> KONTRAK UNIT PRICE</h1>
            <div class="section-header-breadcrumb">
                <div class="breadcrumb-item active"><a href="<?= base_url('admin/data_kontrak/kelola_level_unit_price/') . $row_kontrak['id_kontrak'] ?>">KONTRAK UNIT PRICE</a></div>
            </div>
        </div>
                        ...
                        <div class="col-md-12">
                            <div class="card card-outline card-primary">
                                <div class="card-header">
                                    <h5 class="card-title">
                                        Kelola Level Kontrak <?= $row_kontrak['nama_kontrak'] ?>
                                        <input type="hidden" name="id_kontrak" id="id_kontrak" value="<?= $row_kontrak['id_kontrak'] ?>">
                                    </h5>
                                </div>
                                <!-- /.card-header -->
                                <div class="card-body">
                                    <table id="table_kontrak" class="table table-bordered" style="width: 100%;">
                                        <thead>
                                            <tr>
                                                <th class=" text-center" rowspan="2"></th>
                                                <th class=" text-center" rowspan="2">No</th>
                                                <th class=" text-center" rowspan="2">Nama Uraian</th>
                                                <th class=" text-center" rowspan="2">Satuan</th>
                                                <th class=" text-center" colspan="3">Rencana Addendum</th>
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($query_tbl_unit_price->result_array() as $value_tb_unit_price) { ?>
                                                ...
                                                <tr>
                                                    <td class="">Level 1</td>
                                                    <td class=""><?= $value_tb_unit_price['no_urut']; ?></td>
                                                    <td class=""><?= $value_tb_unit_price['nama_uraian']; ?></td>
                                                    <td class=""><?= $value_tb_unit_price['satuan']; ?></td>
                                                    <td class=""><?= $value_tb_unit_price['kuantitas']; ?></td>
                                                    <td class="">
                                                ...
                                                <div class="modal fade" data-backdrop="false" id="form_modal_level_1_unit_price" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <form action="javascript:;" method="post" id="form_simpan_level_1_unit_price">
                                                                    ...
                                                                    <div class="form-group" style="display: none;" id="form_tambah_level_1_unit_price">
                                                                        <div class="row">
                                                                            <div class="col-md-12">
                                                                    ...
                                                                    <div class="form-group" style="display: none;" id="form_input_nilai_level_1_unit_price">
                                                                        ...
                                                                        <div class="row">
                                                                            <div class="col-6">
                                                                                <div class="input-group-prepend">
                                                                                    ...
                                                                                    <input type="text" class="form-control harga_satuan" name="harga_satuan" aria-describedby="helpId" placeholder="Jumlah Nilai">
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-6">
                                                                                <input type="text" disabled class="float-right form-control form-control-sm mt-1" style="width: 200px;" id="rupiah_harga_satuan_level_1_unit_price">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </form>
                                                            ...
                                                            <div class="modal-footer">
                                                                ...
                                                                <a href="javascript:;" style="display: none;" id="button_update_nilai_level_1_unit_price" class="btn btn-success button_simpan" onclick="Simpan_level_1_unit_price('update_nilai_level_1_unit_price')">Simpan</a>
                                                                <a href="javascript:;" id="button_tambah_level_1_unit_price" class="btn btn-success button_simpan" onclick="Simpan_level_1_unit_price('tambah_level_1_unit_price')">Update</a>
                                                                <a href="javascript:;" id="button_edit_level_1_unit_price" class="btn btn-success button_simpan" onclick="Simpan_level_1_unit_price('edit_level_1_unit_price')">Edit</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                foreach ($query_tbl_unit_price_1->result_array() as $value_tb_unit_price_1) { ?>
                                                    ...
                                                    <tr>
                                                        <td class="">Level 2</td>
                                                        <td class=""><?= $value_tb_unit_price_1['no_urut']; ?></td>
                                                        <td class=""><?= $value_tb_unit_price_1['nama_uraian']; ?></td>
                                                        <td class=""><?= $value_tb_unit_price_1['satuan']; ?></td>
                                                        <td class=""><?= $value_tb_unit_price_1['kuantitas']; ?></td>
                                                        <td class="">
                                                    ...
                                                    <div class="modal fade" data-backdrop="false" id="form_modal_level_2_unit_price" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
                                                        <div class="modal-dialog" role="document">
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                ...
                                                                <div class="modal-body">
                                                                    <form action="javascript:;" method="post" id="form_simpan_level_2_unit_price">

                                                                        <input type="hidden" name="id_unit_price">
                                                                        <input type="hidden" name="id_kontrak" value="<?= $row_kontrak['id_kontrak'] ?>">
                                                                        <input type="text" name="grand_total_post">
                                                                        <div class="form-group" style="display: none;" id="form_tambah_level_2_unit_price">
                                                                            <div class="row">
                                                                                <div class="col-md-12">
                                                                                    <div class="form-group">
                                                                                        <label for="">Nama Uraian</label>
                                                                        ...
                                                                        <div class="form-group" style="display: none;" id="form_input_nilai_level_2_unit_price">
                                                                            <label for="">Satuan</label>
                                                                            <div class="row">
                                                                                <div class="col-12">
                                                                                    <div class="input-group-prepend">
                                                                            ...
                                                                            <div class="row">
                                                                                ...
                                                                                <div class="col-6">
                                                                                    <input type="text" disabled class="float-right form-control form-control-sm mt-1" style="width: 200px;" id="rupiah_harga_satuan_level_2_unit_price">
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </form>
                                                                ...
                                                                <div class="modal-footer">
                                                                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                                                    <a href="javascript:;" style="display: none;" id="button_update_nilai_level_2_unit_price" class="btn btn-success button_simpan" onclick="Simpan_level_2_unit_price('update_nilai_level_2_unit_price')">Simpan</a>
                                                                    <a href="javascript:;" id="button_tambah_level_2_unit_price" class="btn btn-success button_simpan" onclick="Simpan_level_2_unit_price('tambah_level_2_unit_price')">Update</a>
                                                                    <a href="javascript:;" id="button_edit_level_2_unit_price" class="btn btn-success button_simpan" onclick="Simpan_level_2_unit_price('edit_level_2_unit_price')">Edit</a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    foreach ($query_tbl_unit_price_2->result_array() as $value_tb_unit_price_2) { ?>
                                                        ...
                                                        <tr>
                                                            <td class="">Level 3</td>
                                                            <td class=""><?= $value_tb_unit_price_2['no_urut']; ?></td>
                                                            <td class=""><?= $value_tb_unit_price_2['nama_uraian']; ?></td>
                                                            <td class=""><?= $value_tb_unit_price_2['satuan']; ?></td>
                                                            <td class=""><?= $value_tb_unit_price_2['kuantitas']; ?></td>
                                                            <td class="">
                                                            ...
                                                            <td class="">
                                                                <?php if ($value_tb_unit_price_2['harga_satuan'] == null || $value_tb_unit_price_2['harga_satuan'] == 0) { ?>
                                                                    ...
                                                                    <?php    } else { ?>
                                                                        <a onclick="modal_level_3_unit_price(<?= $value_tb_unit_price_2['id_unit_price_2'] ?>,'update_nilai_level_3_unit_price')" class="btn btn-sm btn-warning" href="javascript:;"><i class="fas fa-dollar-sign"></i></a>
                                                                        <a onclick="modal_level_3_unit_price(<?= $value_tb_unit_price_2['id_unit_price_2'] ?>,'tambah_level_3_unit_price')" class="btn btn-sm btn-primary" href="javascript:;"><i class="fas fa-plus"></i></a>
                                                        ...
                                                        <div class="modal fade" data-backdrop="false" id="form_modal_level_3_unit_price" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
                                                            <div class="modal-dialog" role="document">
                                                                <div class="modal-content">
                                                                    <div class="modal-header">
                                                                    ...
                                                                    <div class="modal-body">
                                                                        <form action="javascript:;" method="post" id="form_simpan_level_3_unit_price">

                                                                            <input type="hidden" name="id_unit_price">
                                                                            <input type="hidden" name="id_kontrak" value="<?= $row_kontrak['id_kontrak'] ?>">
                                                                            <input type="text" name="grand_total_post">
                                                                            <div class="form-group" style="display: none;" id="form_tambah_level_3_unit_price">
                                                                                <div class="row">
                                                                                    <div class="col-md-12">
                                                                                        <div class="form-group">
                                                                                            <label for="">Nama Uraian</label>
                                                                            ...
                                                                            <div class="form-group" style="display: none;" id="form_input_nilai_level_3_unit_price">
                                                                                <label for="">Satuan</label>
                                                                                <div class="row">
                                                                                    <div class="col-12">
                                                                                        <div class="input-group-prepend">
                                                                                ...
                                                                                <div class="row">
                                                                                    ...
                                                                                    <div class="col-6">
                                                                                        <input type="text" disabled class="float-right form-control form-control-sm mt-1" style="width: 200px;" id="rupiah_harga_satuan_level_3_unit_price">
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                        </form>
                                                                    ...
                                                                    <div class="modal-footer">
                                                                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                                                        <a href="javascript:;" style="display: none;" id="button_update_nilai_level_3_unit_price" class="btn btn-success button_simpan" onclick="Simpan_level_3_unit_price('update_nilai_level_3_unit_price')">Simpan</a>
                                                                        <a href="javascript:;" id="button_tambah_level_3_unit_price" class="btn btn-success button_simpan" onclick="Simpan_level_3_unit_price('tambah_level_3_unit_price')">Update</a>
                                                                        <a href="javascript:;" id="button_edit_level_3_unit_price" class="btn btn-success button_simpan" onclick="Simpan_level_3_unit_price('edit_level_3_unit_price')">Edit</a>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        foreach ($query_tbl_unit_price_3->result_array() as $value_tb_unit_price_3) { ?>
                                                            ...
                                                            <tr>
                                                                <td class="">Level 4</td>
                                                                <td class=""><?= $value_tb_unit_price_3['no_urut']; ?></td>
                                                                <td class=""><?= $value_tb_unit_price_3['nama_uraian']; ?></td>
                                                                <td class=""><?= $value_tb_unit_price_3['satuan']; ?></td>
                                                                <td class=""><?= $value_tb_unit_price_3['kuantitas']; ?></td>
                                                                <td class="">
                                                                ...
                                                                <td class="">
                                                                    <?php if ($value_tb_unit_price_3['harga_satuan'] == null || $value_tb_unit_price_3['harga_satuan'] == 0) { ?>
                                                                        ...
                                                                        <?php    } else { ?>
                                                                            <a onclick="modal_level_4_unit_price(<?= $value_tb_unit_price_3['id_unit_price_3'] ?>,'update_nilai_level_4_unit_price')" class="btn btn-sm btn-warning" href="javascript:;"><i class="fas fa-dollar-sign"></i></a>
                                                                            <a onclick="modal_level_4_unit_price(<?= $value_tb_unit_price_3['id_unit_price_3'] ?>,'tambah_level_4_unit_price')" class="btn btn-sm btn-primary" href="javascript:;"><i class="fas fa-plus"></i></a>
                                                            ...
                                                            <div class="modal fade" data-backdrop="false" id="form_modal_level_4_unit_price" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
                                                                <div class="modal-dialog" role="document">
                                                                    <div class="modal-content">
                                                                        <div class="modal-header">
                                                                        ...
                                                                        <div class="modal-body">
                                                                            <form action="javascript:;" method="post" id="form_simpan_level_4_unit_price">

                                                                                <input type="hidden" name="id_unit_price">
                                                                                <input type="hidden" name="id_kontrak" value="<?= $row_kontrak['id_kontrak'] ?>">
                                                                                <input type="text" name="grand_total_post">
                                                                                <div class="form-group" style="display: none;" id="form_tambah_level_4_unit_price">
                                                                                    <div class="row">
                                                                                        <div class="col-md-12">
                                                                                            <div class="form-group">
                                                                                                <label for="">Nama Uraian</label>
                                                                                ...
                                                                                <div class="form-group" style="display: none;" id="form_input_nilai_level_4_unit_price">
                                                                                    <label for="">Satuan</label>
                                                                                    <div class="row">
                                                                                        <div class="col-12">
                                                                                            <div class="input-group-prepend">
                                                                                    ...
                                                                                    <div class="row">
                                                                                        ...
                                                                                        <div class="col-6">
                                                                                            <input type="text" disabled class="float-right form-control form-control-sm mt-1" style="width: 200px;" id="rupiah_harga_satuan_level_4_unit_price">
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                            </form>
                                                                        ...
                                                                        <div class="modal-footer">
                                                                            <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                                                            <a href="javascript:;" style="display: none;" id="button_update_nilai_level_4_unit_price" class="btn btn-success button_simpan" onclick="Simpan_level_4_unit_price('update_nilai_level_4_unit_price')">Simpan</a>
                                                                            <a href="javascript:;" id="button_tambah_level_4_unit_price" class="btn btn-success button_simpan" onclick="Simpan_level_4_unit_price('tambah_level_4_unit_price')">Update</a>
                                                                            <a href="javascript:;" id="button_edit_level_4_unit_price" class="btn btn-success button_simpan" onclick="Simpan_level_4_unit_price('edit_level_4_unit_price')">Edit</a>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            foreach ($query_tbl_unit_price_4->result_array() as $value_tb_unit_price_4) { ?>
                                                                ...
                                                                <tr>
                                                                    <td class="">Level 5</td>
                                                                    <td class=""><?= $value_tb_unit_price_4['no_urut']; ?></td>
                                                                    <td class=""><?= $value_tb_unit_price_4['nama_uraian']; ?></td>
                                                                    <td class=""><?= $value_tb_unit_price_4['satuan']; ?></td>
                                                                    <td class=""><?= $value_tb_unit_price_4['kuantitas']; ?></td>
                                                                    <td class="">
                                                                ...
                                                                <div class="modal fade" data-backdrop="false" id="form_modal_level_5_unit_price" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
                                                                    <div class="modal-dialog" role="document">
                                                                        <div class="modal-content">
                                                                            <div class="modal-header">
                                                                            ...
                                                                            <div class="modal-body">
                                                                                <form action="javascript:;" method="post" id="form_simpan_level_5_unit_price">

                                                                                    <input type="hidden" name="id_unit_price">
                                                                                    <input type="hidden" name="id_kontrak" value="<?= $row_kontrak['id_kontrak'] ?>">
                                                                                    <input type="text" name="grand_total_post">
                                                                                    <div class="form-group" style="display: none;" id="form_tambah_level_5_unit_price">
                                                                                        <div class="row">
                                                                                            <div class="col-md-12">
                                                                                                <div class="form-group">
                                                                                                    <label for="">Nama Uraian</label>
                                                                                    ...
                                                                                    <div class="form-group" style="display: none;" id="form_input_nilai_level_5_unit_price">
                                                                                        <label for="">Satuan</label>
                                                                                        <div class="row">
                                                                                            <div class="col-12">
                                                                                                <div class="input-group-prepend">
                                                                                        ...
                                                                                        <div class="row">
                                                                                            ...
                                                                                            <div class="col-6">
                                                                                                <input type="text" disabled class="float-right form-control form-control-sm mt-1" style="width: 200px;" id="rupiah_harga_satuan_level_5_unit_price">
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                                </form>
                                                                            ...
                                                                            <div class="modal-footer">
                                                                                <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                                                                <a href="javascript:;" style="display: none;" id="button_update_nilai_level_5_unit_price" class="btn btn-success button_simpan" onclick="Simpan_level_5_unit_price('update_nilai_level_5_unit_price')">Simpan</a>
                                                                                <a href="javascript:;" id="button_tambah_level_5_unit_price" class="btn btn-success button_simpan" onclick="Simpan_level_5_unit_price('tambah_level_5_unit_price')">Update</a>
                                                                                <a href="javascript:;" id="button_edit_level_5_unit_price" class="btn btn-success button_simpan" onclick="Simpan_level_5_unit_price('edit_level_5_unit_price')">Edit</a>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                foreach ($query_tbl_unit_price_5->result_array() as $value_tb_unit_price_5) { ?>
                                                                    ...
                                                                    <tr>
                                                                        <td class="">Level 6</td>
                                                                        <td class=""><?= $value_tb_unit_price_5['no_urut']; ?></td>
                                                                        <td class=""><?= $value_tb_unit_price_5['nama_uraian']; ?></td>
                                                                        <td class=""><?= $value_tb_unit_price_5['satuan']; ?></td>
                                                                        <td class=""><?= $value_tb_unit_price_5['kuantitas']; ?></td>
                                                                        <td class="">
                                                                    ...
                                                                    <div class="modal fade" data-backdrop="false" id="form_modal_level_6_unit_price" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
                                                                        <div class="modal-dialog" role="document">
                                                                            <div class="modal-content">
                                                                                <div class="modal-header">
                                                                                ...
                                                                                <div class="modal-body">
                                                                                    <form action="javascript:;" method="post" id="form_simpan_level_6_unit_price">

                                                                                        <input type="hidden" name="id_unit_price">
                                                                                        <input type="hidden" name="id_kontrak" value="<?= $row_kontrak['id_kontrak'] ?>">
                                                                                        <input type="text" name="grand_total_post">
                                                                                        <div class="form-group" style="display: none;" id="form_tambah_level_6_unit_price">
                                                                                            <div class="row">
                                                                                                <div class="col-md-12">
                                                                                                    <div class="form-group">
                                                                                                        <label for="">Nama Uraian</label>
                                                                                        ...
                                                                                        <div class="form-group" style="display: none;" id="form_input_nilai_level_6_unit_price">
                                                                                            <label for="">Satuan</label>
                                                                                            <div class="row">
                                                                                                <div class="col-12">
                                                                                                    <div class="input-group-prepend">
                                                                                            ...
                                                                                            <div class="row">
                                                                                                ...
                                                                                                <div class="col-6">
                                                                                                    <input type="text" disabled class="float-right form-control form-control-sm mt-1" style="width: 200px;" id="rupiah_harga_satuan_level_6_unit_price">
                                                                                                </div>
                                                                                            </div>
                                                                                        </div>
                                                                                    </form>
                                                                                ...
                                                                                <div class="modal-footer">
                                                                                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                                                                    <a href="javascript:;" style="display: none;" id="button_update_nilai_level_6_unit_price" class="btn btn-success button_simpan" onclick="Simpan_level_6_unit_price('update_nilai_level_6_unit_price')">Simpan</a>
                                                                                    <a href="javascript:;" id="button_tambah_level_6_unit_price" class="btn btn-success button_simpan" onclick="Simpan_level_6_unit_price('tambah_level_6_unit_price')">Update</a>
                                                                                    <a href="javascript:;" id="button_edit_level_6_unit_price" class="btn btn-success button_simpan" onclick="Simpan_level_6_unit_price('edit_level_6_unit_price')">Edit</a>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    foreach ($query_tbl_unit_price_6->result_array() as $value_tb_unit_price_6) { ?>
                                                                        ...
                                                                        <tr>
                                                                            <td class="">Level 7</td>
                                                                            <td class=""><?= $value_tb_unit_price_6['no_urut']; ?></td>
                                                                            <td class=""><?= $value_tb_unit_price_6['nama_uraian']; ?></td>
                                                                            <td class=""><?= $value_tb_unit_price_6['satuan']; ?></td>
                                                                            <td class=""><?= $value_tb_unit_price_6['kuantitas']; ?></td>
                                                                            <td class="">
                                                                        ...
                                                                        <div class="modal fade" data-backdrop="false" id="form_modal_level_7_unit_price" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
                                                                            <div class="modal-dialog" role="document">
                                                                                <div class="modal-content">
                                                                                    <div class="modal-header">
                                                                                    ...
                                                                                    <div class="modal-body">
                                                                                        <form action="javascript:;" method="post" id="form_simpan_level_7_unit_price">

                                                                                            <input type="hidden" name="id_unit_price">
                                                                                            <input type="hidden" name="id_kontrak" value="<?= $row_kontrak['id_kontrak'] ?>">
                                                                                            <input type="text" name="grand_total_post">
                                                                                            <div class="form-group" style="display: none;" id="form_tambah_level_7_unit_price">
                                                                                                <div class="row">
                                                                                                    <div class="col-md-12">
                                                                                                        <div class="form-group">
                                                                                                            <label for="">Nama Uraian</label>
                                                                                            ...
                                                                                            <div class="form-group" style="display: none;" id="form_input_nilai_level_7_unit_price">
                                                                                                <label for="">Satuan</label>
                                                                                                <div class="row">
                                                                                                    <div class="col-12">
                                                                                                        <div class="input-group-prepend">
                                                                                                ...
                                                                                                <div class="row">
                                                                                                    ...
                                                                                                    <div class="col-6">
                                                                                                        <input type="text" disabled class="float-right form-control form-control-sm mt-1" style="width: 200px;" id="rupiah_harga_satuan_level_7_unit_price">
                                                                                                    </div>
                                                                                                </div>
                                                                                            </div>
                                                                                        </form>
                                                                                    ...
                                                                                    <div class="modal-footer">
                                                                                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                                                                        <a href="javascript:;" style="display: none;" id="button_update_nilai_level_7_unit_price" class="btn btn-success button_simpan" onclick="Simpan_level_7_unit_price('update_nilai_level_7_unit_price')">Simpan</a>
                                                                                        <a href="javascript:;" id="button_tambah_level_7_unit_price" class="btn btn-success button_simpan" onclick="Simpan_level_7_unit_price('tambah_level_7_unit_price')">Update</a>
                                                                                        <a href="javascript:;" id="button_edit_level_7_unit_price" class="btn btn-success button_simpan" onclick="Simpan_level_7_unit_price('edit_level_7_unit_price')">Edit</a>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        foreach ($query_tbl_unit_price_7->result_array() as $value_tb_unit_price_7) { ?>
                                                                            ...
                                                                            <tr>
                                                                                <td class="">Level 8</td>
                                                                                <td class=""><?= $value_tb_unit_price_7['no_urut']; ?></td>
                                                                                <td class=""><?= $value_tb_unit_price_7['nama_uraian']; ?></td>
                                                                                <td class=""><?= $value_tb_unit_price_7['satuan']; ?></td>
                                                                                <td class=""><?= $value_tb_unit_price_7['kuantitas']; ?></td>
                                                                                <td class="">
                                                                            ...
                                                                            <div class="modal fade" data-backdrop="false" id="form_modal_level_8_unit_price" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
                                                                                <div class="modal-dialog" role="document">
                                                                                    <div class="modal-content">
                                                                                        <div class="modal-header">
                                                                                        ...
                                                                                        <div class="modal-body">
                                                                                            <form action="javascript:;" method="post" id="form_simpan_level_8_unit_price">

                                                                                                <input type="hidden" name="id_unit_price">
                                                                                                <input type="hidden" name="id_kontrak" value="<?= $row_kontrak['id_kontrak'] ?>">
                                                                                                <input type="text" name="grand_total_post">
                                                                                                <div class="form-group" style="display: none;" id="form_tambah_level_8_unit_price">
                                                                                                    <div class="row">
                                                                                                        <div class="col-md-12">
                                                                                                            <div class="form-group">
                                                                                                                <label for="">Nama Uraian</label>
                                                                                                ...
                                                                                                <div class="form-group" style="display: none;" id="form_input_nilai_level_8_unit_price">
                                                                                                    <label for="">Satuan</label>
                                                                                                    <div class="row">
                                                                                                        <div class="col-12">
                                                                                                            <div class="input-group-prepend">
                                                                                                    ...
                                                                                                    <div class="row">
                                                                                                        ...
                                                                                                        <div class="col-6">
                                                                                                            <input type="text" disabled class="float-right form-control form-control-sm mt-1" style="width: 200px;" id="rupiah_harga_satuan_level_8_unit_price">
                                                                                                        </div>
                                                                                                    </div>
                                                                                                </div>
                                                                                            </form>
                                                                                        ...
                                                                                        <div class="modal-footer">
                                                                                            <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                                                                            <a href="javascript:;" style="display: none;" id="button_update_nilai_level_8_unit_price" class="btn btn-success button_simpan" onclick="Simpan_level_8_unit_price('update_nilai_level_8_unit_price')">Simpan</a>
                                                                                            <a href="javascript:;" id="button_tambah_level_8_unit_price" class="btn btn-success button_simpan" onclick="Simpan_level_8_unit_price('tambah_level_8_unit_price')">Update</a>
                                                                                            <a href="javascript:;" id="button_edit_level_8_unit_price" class="btn btn-success button_simpan" onclick="Simpan_level_8_unit_price('edit_level_8_unit_price')">Edit</a>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                            ...
                                                                            foreach ($query_tbl_unit_price_8->result_array() as $value_tb_unit_price_8) { ?>
                                                                                ...
                                                                                <tr>
                                                                                    <td class="">Level 9</td>
                                                                                    <td class=""><?= $value_tb_unit_price_8['no_urut']; ?></td>
                                                                                    <td class=""><?= $value_tb_unit_price_8['nama_uraian']; ?></td>
                                                                                    <td class=""><?= $value_tb_unit_price_8['satuan']; ?></td>
                                                                                    <td class=""><?= $value_tb_unit_price_8['kuantitas']; ?></td>
                                                                                    <td class="">
                                                                                ...
                                                                                <div class="modal fade" data-backdrop="false" id="form_modal_level_9_unit_price" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
                                                                                    <div class="modal-dialog" role="document">
                                                                                        <div class="modal-content">
                                                                                            <div class="modal-header">
                                                                                            ...
                                                                                            <div class="modal-body">
                                                                                                <form action="javascript:;" method="post" id="form_simpan_level_9_unit_price">

                                                                                                    <input type="hidden" name="id_unit_price">
                                                                                                    <input type="hidden" name="id_kontrak" value="<?= $row_kontrak['id_kontrak'] ?>">
                                                                                                    <input type="text" name="grand_total_post">
                                                                                                    <div class="form-group" style="display: none;" id="form_tambah_level_9_unit_price">
                                                                                                        <div class="row">
                                                                                                            <div class="col-md-12">
                                                                                                                <div class="form-group">
                                                                                                                    <label for="">Nama Uraian</label>
                                                                                                    ...
                                                                                                    <div class="form-group" style="display: none;" id="form_input_nilai_level_9_unit_price">
                                                                                                        <label for="">Satuan</label>
                                                                                                        <div class="row">
                                                                                                            <div class="col-12">
                                                                                                                <div class="input-group-prepend">
                                                                                                        ...
                                                                                                        <div class="row">
                                                                                                            ...
                                                                                                            <div class="col-6">
                                                                                                                <input type="text" disabled class="float-right form-control form-control-sm mt-1" style="width: 200px;" id="rupiah_harga_satuan_level_9_unit_price">
                                                                                                            </div>
                                                                                                        </div>
                                                                                                    </div>
                                                                                                </form>
                                                                                            ...
                                                                                            <div class="modal-footer">
                                                                                                <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                                                                                <a href="javascript:;" style="display: none;" id="button_update_nilai_level_9_unit_price" class="btn btn-success button_simpan" onclick="Simpan_level_9_unit_price('update_nilai_level_9_unit_price')">Simpan</a>
                                                                                                <a href="javascript:;" id="button_tambah_level_9_unit_price" class="btn btn-success button_simpan" onclick="Simpan_level_9_unit_price('tambah_level_9_unit_price')">Update</a>
                                                                                                <a href="javascript:;" id="button_edit_level_9_unit_price" class="btn btn-success button_simpan" onclick="Simpan_level_9_unit_price('edit_level_9_unit_price')">Edit</a>
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                                ...
                                                                                foreach ($query_tbl_unit_price_9->result_array() as $value_tb_unit_price_9) { ?>
                                                                                    ...
                                                                                    <tr>
                                                                                        ...
                                                                                        <td class=""><?= $value_tb_unit_price_9['no_urut']; ?></td>
                                                                                        <td class=""><?= $value_tb_unit_price_9['nama_uraian']; ?></td>
                                                                                        <td class=""><?= $value_tb_unit_price_9['satuan']; ?></td>
                                                                                        <td class=""><?= $value_tb_unit_price_9['kuantitas']; ?></td>
                                                                                        <td class="">
                                                                                    ...
                                                                                    <div class="modal fade" data-backdrop="false" id="form_modal_level_10_unit_price" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
                                                                                        <div class="modal-dialog" role="document">
                                                                                            <div class="modal-content">
                                                                                                <div class="modal-header">
                                                                                                ...
                                                                                                <div class="modal-body">
                                                                                                    <form action="javascript:;" method="post" id="form_simpan_level_10_unit_price">

                                                                                                        <input type="hidden" name="id_unit_price">
                                                                                                        <input type="hidden" name="id_kontrak" value="<?= $row_kontrak['id_kontrak'] ?>">
                                                                                                        <input type="text" name="grand_total_post">
                                                                                                        <div class="form-group" style="display: none;" id="form_tambah_level_10_unit_price">
                                                                                                            <div class="row">
                                                                                                                <div class="col-md-12">
                                                                                                                    <div class="form-group">
                                                                                                                        <label for="">Nama Uraian</label>
                                                                                                        ...
                                                                                                        <div class="form-group" style="display: none;" id="form_input_nilai_level_10_unit_price">
                                                                                                            <label for="">Satuan</label>
                                                                                                            <div class="row">
                                                                                                                <div class="col-12">
                                                                                                                    <div class="input-group-prepend">
                                                                                                            ...
                                                                                                            <div class="row">
                                                                                                                ...
                                                                                                                <div class="col-6">
                                                                                                                    <input type="text" disabled class="float-right form-control form-control-sm mt-1" style="width: 200px;" id="rupiah_harga_satuan_level_10_unit_price">
                                                                                                                </div>
                                                                                                            </div>
                                                                                                        </div>
                                                                                                    </form>
                                                                                                ...
                                                                                                <div class="modal-footer">
                                                                                                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                                                                                    <a href="javascript:;" style="display: none;" id="button_update_nilai_level_10_unit_price" class="btn btn-success button_simpan" onclick="Simpan_level_10_unit_price('update_nilai_level_10_unit_price')">Simpan</a>
                                                                                                    <a href="javascript:;" id="button_tambah_level_10_unit_price" class="btn btn-success button_simpan" onclick="Simpan_level_10_unit_price('tambah_level_10_unit_price')">Update</a>
                                                                                                    <a href="javascript:;" id="button_edit_level_10_unit_price" class="btn btn-success button_simpan" onclick="Simpan_level_10_unit_price('edit_level_10_unit_price')">Edit</a>
                                                                                                </div>
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                                    ...
                                                                                    foreach ($query_tbl_unit_price_10->result_array() as $value_tb_unit_price_10) { ?>
                                                                                        ...
                                                                                        <tr>
                                                                                            ...
                                                                                            <td class=""><?= $value_tb_unit_price_10['no_urut']; ?></td>
                                                                                            <td class=""><?= $value_tb_unit_price_10['nama_uraian']; ?></td>
                                                                                            <td class=""><?= $value_tb_unit_price_10['satuan']; ?></td>
                                                                                            <td class=""><?= $value_tb_unit_price_10['kuantitas']; ?></td>
                                                                                            <td class="">
                                                                                        ...
                                                                                        <div class="modal fade" data-backdrop="false" id="form_modal_level_11_unit_price" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
                                                                                            <div class="modal-dialog" role="document">
                                                                                                <div class="modal-content">
                                                                                                    <div class="modal-header">
                                                                                                    ...
                                                                                                    form_simpan_level_11_unit_price">
                                                                                                            ...
                                                                                                            <input type="hidden" name="id_kontrak" value="<?= $row_kontrak['id_kontrak'] ?>">
                                                                                                            <input type="text" name="grand_total_post">
                                                                                                            <div class="form-group" style="display: none;" id="form_tambah_level_11_unit_price">
                                                                                                                <div class="row">
                                                                                                                    <div class="col-md-12">
                                                                                                                        <div class="form-group">
                                                                                                                            <label for="">Nama Uraian</label>
                                                                                                            ...
                                                                                                            <div class="form-group" style="display: none;" id="form_input_nilai_level_11_unit_price">
                                                                                                                <label for="">Satuan</label>
                                                                                                                <div class="row">
                                                                                                                    <div class="col-12">
                                                                                                                        <div class="input-group-prepend">
                                                                                                                ...
                                                                                                                <div class="row">
                                                                                                                    ...
                                                                                                                    <div class="col-6">
                                                                                                                        <input type="text" disabled class="float-right form-control form-control-sm mt-1" style="width: 200px;" id="rupiah_harga_satuan_level_11_unit_price">
                                                                                                                    </div>
                                                                                                                </div>
                                                                                                            </div>
                                                                                                        </form>
                                                                                                    ...
                                                                                                    <div class="modal-footer">
                                                                                                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                                                                                        <a href="javascript:;" style="display: none;" id="button_update_nilai_level_11_unit_price" class="btn btn-success button_simpan" onclick="Simpan_level_11_unit_price('update_nilai_level_11_unit_price')">Simpan</a>
                                                                                                        <a href="javascript:;" id="button_tambah_level_11_unit_price" class="btn btn-success button_simpan" onclick="Simpan_level_11_unit_price('tambah_level_11_unit_price')">Update</a>
                                                                                                        <a href="javascript:;" id="button_edit_level_11_unit_price" class="btn btn-success button_simpan" onclick="Simpan_level_11_unit_price('edit_level_11_unit_price')">Edit</a>
                                                                                                    </div>
                                                                                                </div>
                                                                                            </div>
                                                                                        </div>
        ...
        <!-- Modal -->
        <div class="modal fade" data-backdrop="false" id="add_level_1" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <div class="modal-body">
                        <form action="javascript;;" id="form_add_level_1" method="post">
                            ...
                            <div class="form-group">
                                <label for="">Nama Uraian</label>
                                <input type="text" name="nama_uraian" id="" class="form-control" placeholder="Masukan Nama Uraian">
                            </div>
                        </form>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                        <a href="javascript:;" id="button_add_level_1" class="btn btn-success button_add_level_1" onclick="Simpan_add_level_1('tambah_level_1')">Simpan</a>
                    </div>
                </div>
            </div>
        </div>
