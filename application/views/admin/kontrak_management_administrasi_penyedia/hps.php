...
<div class="main-content">
  ...
  position: fixed; top:50px;  padding-bottom: -10px;">
            <b style="margin-left: auto; font-weight:1000" class="text-black">(<?= $nama_kontrak['nama_kontrak'] ?>) (<?= $nama_kontrak['tahun_anggaran'] ?>) - Lembar Kerja - Pra Pengadaan - Isi Nilai HPS</b>
        </nav>
...
background: linear-gradient(188deg, rgba(36,93,120,1) 47%, rgba(1,118,205,1) 92%); color:white">
            ...
            <label for="">Nama Pekerjaan : <?= $row_program['nama_pekerjaan_program_mata_anggaran'] ?></label>

        </div>
        <div class="card" style="margin-top: -20px; padding: 10px;background: rgb(36,93,120);
background: linear-gradient(188deg, rgba(36,93,120,1) 47%, rgba(1,118,205,1) 92%); color:white">

            <label for="">Setelah Anda Selesai Membuat DKH Harap Lakukan Validasi Dengan Menekan Tombol Simpan dan Update Yang Berada Pada Bawah Table</label>
        ...
        <div class="card" style="margin-top: -65px; padding: 10px;">
        ...
        <div class="card" style="margin-top: -18px; padding: 20px">
            ...
            <h6>PPN</h6>
            <h6>TOTAL (SETELAH PPN)</h6>
        </div>

        <div class="card" style="margin-top: -18px; padding: 20px">
            <h6>*Buat Uraian Manual dengan melakukan input per baris sesuai Daftar Kuantitas Harga yang diinginkan</h6>
            <h6>*Buat Uraian Excel dengan melakukan download dan upload excel pada format yang telah disediakan dalam sistem</h6>
            <h6>*DKH dalam sistem tidak dapat dilakukan pembulatan untuk menghindari error pada sistem</h6>
        </div>
