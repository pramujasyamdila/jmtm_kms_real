<div class="container">
    <a target="_blank" href="<?= base_url('admin/administrasi_penyedia/cetak_pip_persejutuan/' . $row_program['id_detail_program_penyedia_jasa']) ?>" class="btn btn-sm btn-primary">Cetak <i class="fa fa-print"></i></a>
    <div class="row">
        <div class="col-md-6">
