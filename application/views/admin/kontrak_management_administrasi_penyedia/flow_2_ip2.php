<div class="container">
    <a target="_blank" href="<?= base_url('admin/administrasi_penyedia/cetak_pip2/' . $row_program['id_detail_program_penyedia_jasa']) ?>" class="btn btn-sm btn-primary">Cetak <i class="fa fa-print"></i></a>
    <div class="row">
        <div class="col-md-6">
            <img src="https://jmtm.co.id/assets/img_jmtm/logo.png" alt="" width="300px" style="margin-top:50px">
        </div>
    </div><br><br>
    <input type="hidden" name="type_pip_number" value="2">
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <input type="text" style="margin-left: -80px;" class="" name="no_surat_pip_gm_ke_dirops" placeholder="No Surat">
        </div>
        <div class="col-md-2">
        </div>
        <div class="col-md-2">
        ...
        <div class="col-md-2">
            <label for="" style="margin-left: -15px;"><input type="date" class="" name="tgl_surat_pip_gm_ke_dirops"></label>
        </div>
    </div>
    <div class="row">
        <div class="col-md-1">
        ...
        <div class="col-md-4">
            <input type="text" class="" style="margin-left: -80px;" name="lampiran_pip_gm_ke_dirops" placeholder="Lampiran">
        </div>
        <div class="col-md-2">
        </div>
        <div class="col-md-2">
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <center>
                ...
                <br>
                <br><br><br><br>
                <h5><input type="text" name="nama_gm_ke_dirops"></h5>
