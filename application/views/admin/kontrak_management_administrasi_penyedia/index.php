                            ...
                            <div class="col-sm-12">
                                <div class="card card-outline card-warning">
                                    <div class="card-header">
                                        Administrasi Kontrak Penyedia Jasa Pra Pengadaan
                                    </div>
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-1">
                                            ...
                                            <div class="col-md-10">
                                                <div class="card card-primary">
                                                    <div class="card-header text-center">
                                                        <h6> <i class="fa fa-search-plus" aria-hidden="true"></i> FILTER KEYWORD</h6>
                                                    </div>
                                                    <div class="card-body">
                                                    ...
                                                    <table class="table table-bordered" style="width:100%;">
                                                        <thead>
                                                            <tr class="text-center bg-primary">
                                                                ...
                                                                <th class="tg-0pky text-center text-white angga bg-primary " style="font-size: 12px;width:300px !important;border: 1px solid #ccc;" rowspan="2">Uraian Pekerjaan</th>
