<div class="container">
    ...
    <input type="text" name="type_pip_number" value="1">
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <input type="text" style="margin-left: -80px;" class="" name="no_surat_pip_ca_ke_gm" placeholder="No Surat">
        </div>
        <div class="col-md-2">
        </div>
        <div class="col-md-2">
        ...
        <div class="col-md-2">
            <label for="" style="margin-left: -15px;"><input type="date" class="" name="tgl_surat_pip_ca_ke_gm"></label>
        </div>
    </div>
    <div class="row">
        <div class="col-md-1">
        ...
        <div class="col-md-4">
            <input type="text" class="" style="margin-left: -80px;" name="lampiran_pip_ca_ke_gm" placeholder="Lampiran">
        </div>
        <div class="col-md-2">
        </div>
        <div class="col-md-2">
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <center>
                ...
                <br>
                <br><br><br><br>
                <h5><input type="text" name="nama_ca_ke_gm"></h5>
