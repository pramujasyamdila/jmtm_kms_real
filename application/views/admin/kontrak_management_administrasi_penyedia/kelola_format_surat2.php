                            ...
                            <div class="col-sm-12">
                                <div class="container-fluid">
                                    ...
                                    <div style="color:white;width: 100%;background-color: #302B63;font-family: RNSSanz-ExtraBold;padding:20px;border-radius:20px">
                                        <label for="">Flow 2 - Persetujuan Direktur Utama</label> <br><br>
                                        <label for="">1. Permohonan Izin Prinsip Coordinator Area ke General Manager</label><br>
                                        <label for="">2. Permohonan Izin Prinsip General Manager ke Direktur Operasi</label><br>
                                        <label for="">3. Permohonan Izin Prinsip Direktur Operasi ke Direktur Utama</label><br>
                                        <label for="">4. Persetujuan Izin Prinsip Direktur Utama ke Direktur Operasi</label><br>
                                        <label for="">5. Permohonan Harga Perkiraan Sendiri (HPS) Coordinator Area ke General Manager</label><br>
                                        <label for="">6. Permohonan Harga Perkiraan Sendiri (HPS) General Manager ke Direktur Operasi</label><br>
                                        <label for="">7. Permohonan Harga Perkiraan Sendiri (HPS) Direktur Operasi ke Direktur Utama</label><br>
                                        <label for="">8. Persetujuan Harga Perkiraan Sendiri (HPS) Direktur Utama ke Direktur Operasi</label><br>
                                        <label for="">9. Nota Dinas Permohonan Pengadaan General Manager</label><br>
                                    </div>
                                    <br>
                                    ...
                                    <div class="card card-primary card-tabs">
                                        <div class="card-header p-0 pt-1">
                                            <ul class="nav nav-tabs" id="custom-tabs-two-tab" role="tablist">
                                                <li class="pt-2 px-3">
                                                    <h5 class="card-title"><i class="fas fa fa-envelope"></i></h5>
                                                </li>
                                                <li class="nav-item">
                                                    ...
                                                    <div class="card card-outline card-primary">
                                                        ...
                                                        <div class="container">
                                                            <select name="flow_2_ip" onchange="flow_2_ip()" class="form-control">
                                                                ...
                                                                <option value="3">Permohonan IP DIROPS ke DIRUT</option>
                                                                <option value="4">Persetujuan IP DIROPS ke DIRUT</option>
                                                            </select>
                                                        </div>
                                                        <br>
                                                        <div class="render">
                                                                ...
                                                                <div class="card-body">
                                                                    ...
                                                                    <div class="container">
                                                                        <select name="flow_2_hps" onchange="flow_2_hps()" class="form-control">
                                                                            ...
                                                                            <option value="3">Permohonan HPS DIROPS ke DIRUT</option>
                                                                            <option value="4">Persetujuan HPS DIRUT ke DIROPS</option>
                                                                        </select>
                                                                    </div>
                                                                    <br>
                                                            ...
                                                            <div class="card card-outline card-info">
                                                                ...
                                                                <div class="card-body">
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-md-6">
                                                                            <label>: Permohonan Pelaksanaan Pengadaan <b for="" class="jenis_pengadaan"></b> <b for="" class="nama_pekerjaan"></b> </label>
                                                                        </div>
                                                                        <div class="col-md-2">
                                                                    ...
                                                                    <div class="row mt-3">
                                                                        ...
                                                                        <div class="mt-2">
                                                                            <h5>Sehubungan dengan telah ditetapkannya nilai Kontrak Manajemen Bidang Pemeliharaan Jalan Tol
                                                                                Pada Ruas Jalan Tol <b class="nama_area"></b> Tahun 2012 serta Persetujuan Harga Perkiraan Sendini (HPS)
