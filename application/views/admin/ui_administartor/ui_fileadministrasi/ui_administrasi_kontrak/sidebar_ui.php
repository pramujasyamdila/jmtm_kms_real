...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      <img src="<?php echo base_url()?>assets/dist/img/JMTMLOGOKU.png" alt="AdminLTE Logo" class="brand-image elevation-4" style="opacity: .8">
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="http://localhost/smk_ci3/Administrator/Dashboard#" class="nav-link">
          ...
          <li class="nav-item menu-open">
            <a href="http://localhost/smk_ci3/Administrator/FileAdministrasi/DataAdministrasiKontrak" class="nav-link active">
