                                        ...
                                        <div class="container">
                                            <div class="row">
                                                ...
                                                <div class="col-md-5 mt-5" style="margin-left:-70px">
                                                    <center>
                                                        <label>SERAH TERIMA PENGADAAN BARANG/JASA</label>
                                                    </center>
                                                </div>
                                                <div class="col-md-3">
                                            ...
                                            <div class="container-fluid mt-4">
                                                ...
                                                <div class="mt-3">
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <label for="">c. Berita Acara Pemeriksaan Pengadaan Barang/Jasa</label>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <label for=""> </label>
                                                        </div>
                                                ...
                                                <div style="margin-left: 40px;">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-11" style="margin-left: -40px;">
                                                            <label for="">PIHAK KEDUA telah menyelesaikan Pekerjaan Pengadaan Barang/Jasa*) sebesar <?= $total_bobot_mc ?>% pada periode tanggal
                                                                <?= $row_mc['tanggal_mc'] ?> s.d <?= $row_mc['sts_tanggal_trakhir'] ?> dan telah sesuai dengan Berita Acara Pemeriksaan Pekerjaan (BAPP);</label>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-md-1">
                                                        ...
                                                        <div class="col-md-11" style="margin-left: -40px;">
                                                            <label for="">Memperhatikan butir 1 di atas dapat disimpulkan PIHAK KEDUA telah menyelesaikan Pekerjaan Pengadaan Barang/Jasa*) secara
                                                                kumulatif sebesar <?= $total_bobot_mc ?> % sampai dengan tanggal <?= $row_mc['sts_tanggal_trakhir'] ?> ;</label>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-md-1">
                                                        ...
                                                        <div class="col-md-11" style="margin-left: -40px;">
                                                            <label for="">Dengan diselesaikannya pekerjaan sesuai dengan keterangan pada butir 1 diatas, maka PIHAK KEDUA menyerahkan hasil
                                                                ...
                                                                PIHAK KEDUA tetap/tidak*) bertanggung jawab terhadap pekerjaan tersebut sebagaimana dimaksud dalam Kontrak tersebut
                                                                diatas;</label>
                                                        </div>
                                                    </div>
                                                    <div class="row">
