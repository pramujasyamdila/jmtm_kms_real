...
<div class="main-content">
  ...
  position: fixed; top:50px;  padding-bottom: -10px;">
            <b style="margin-left: auto; font-weight:1000" class="text-black">Modul 1 : Kelola Mata Anggaran</b>
        </nav>
...
background: linear-gradient(188deg, rgba(36,93,120,1) 47%, rgba(1,118,205,1) 92%); color:white">
            ...
            <label for="">Modul ini digunakan dalam membuat Mata Anggaran Pada Data Informasi Kontrak Manajemen yang sudah ada</label>
        </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <table id="table" class="table-bordered table-striped" style="font-family: RNSSanz-Black;text-transform: uppercase;">
                        <thead>
                            <tr style="font-size: 13px; height:10px; background-color: #193B53;" class="">
                                ...
                                <th class="text-center text-white " style="width:100px;" rowspan="2">Departemen</th>
                                <th class="text-center text-white " style="width:100px;" rowspan="2">Area</th>
                                <th class="text-center text-white " style="width:100px;" rowspan="2">Sub Area</th>
