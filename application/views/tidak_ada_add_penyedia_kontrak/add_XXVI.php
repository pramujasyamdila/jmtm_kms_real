<?php
    ...
    foreach ($query_tbl_hps_penyedia_kontrak_1->result_array() as $key => $value_hps_penyedia_kontrak_1) {
        ...
        $data_hps_penyedia_kontrak_1 = [
            // uraian_hps_
            'uraian_hps_addendum_26' => $value_hps_penyedia_kontrak_1['uraian_hps'],
            // satuan_hps_
            'satuan_hps_addendum_26' => $value_hps_penyedia_kontrak_1['satuan_hps'],
            // volume_hps_
            'volume_hps_addendum_26' => $value_hps_penyedia_kontrak_1['volume_hps'],
            // harga_satuan_hps
            'harga_satuan_hps_addendum_26' => $value_hps_penyedia_kontrak_1['harga_satuan_hps'],
            // total_harga
            'total_harga_addendum_26' => $value_hps_penyedia_kontrak_1['total_harga'],
        ...
        foreach ($query_tbl_hps_penyedia_kontrak_2->result_array() as $key => $value_hps_penyedia_kontrak_2) {
            ...
            $data_hps_penyedia_kontrak_2 = [
                // uraian_hps_
                'uraian_hps_addendum_26' => $value_hps_penyedia_kontrak_2['uraian_hps'],
                // satuan_hps_
                'satuan_hps_addendum_26' => $value_hps_penyedia_kontrak_2['satuan_hps'],
                // volume_hps_
                'volume_hps_addendum_26' => $value_hps_penyedia_kontrak_2['volume_hps'],
                // harga_satuan_hps
                'harga_satuan_hps_addendum_26' => $value_hps_penyedia_kontrak_2['harga_satuan_hps'],
                // total_harga
                'total_harga_addendum_26' => $value_hps_penyedia_kontrak_2['total_harga'],
            ...
            foreach ($query_tbl_hps_penyedia_kontrak_3->result_array() as $key => $value_hps_penyedia_kontrak_3) {
                ...
                $data_hps_penyedia_kontrak_3 = [
                    // uraian_hps_
                    'uraian_hps_addendum_26' => $value_hps_penyedia_kontrak_3['uraian_hps'],
                    // satuan_hps_
                    'satuan_hps_addendum_26' => $value_hps_penyedia_kontrak_3['satuan_hps'],
                    // volume_hps_
                    'volume_hps_addendum_26' => $value_hps_penyedia_kontrak_3['volume_hps'],
                    // harga_satuan_hps
                    'harga_satuan_hps_addendum_26' => $value_hps_penyedia_kontrak_3['harga_satuan_hps'],
                    // total_harga
                    'total_harga_addendum_26' => $value_hps_penyedia_kontrak_3['total_harga'],
                ...
                foreach ($query_tbl_hps_penyedia_kontrak_4->result_array() as $key => $value_hps_penyedia_kontrak_4) {
                    ...
                    $data_hps_penyedia_kontrak_4 = [
                        // uraian_hps_
                        'uraian_hps_addendum_26' => $value_hps_penyedia_kontrak_4['uraian_hps'],
                        // satuan_hps_
                        'satuan_hps_addendum_26' => $value_hps_penyedia_kontrak_4['satuan_hps'],
                        // volume_hps_
                        'volume_hps_addendum_26' => $value_hps_penyedia_kontrak_4['volume_hps'],
                        // harga_satuan_hps
                        'harga_satuan_hps_addendum_26' => $value_hps_penyedia_kontrak_4['harga_satuan_hps'],
                        // total_harga
                        'total_harga_addendum_26' => $value_hps_penyedia_kontrak_4['total_harga'],
                    ...
                    foreach ($query_tbl_hps_penyedia_kontrak_5->result_array() as $key => $value_hps_penyedia_kontrak_5) {
                        ...
                        $data_hps_penyedia_kontrak_5 = [
                            // uraian_hps_
                            'uraian_hps_addendum_26' => $value_hps_penyedia_kontrak_5['uraian_hps'],
                            // satuan_hps_
                            'satuan_hps_addendum_26' => $value_hps_penyedia_kontrak_5['satuan_hps'],
                            // volume_hps_
                            'volume_hps_addendum_26' => $value_hps_penyedia_kontrak_5['volume_hps'],
                            // harga_satuan_hps
                            'harga_satuan_hps_addendum_26' => $value_hps_penyedia_kontrak_5['harga_satuan_hps'],
                            // total_harga
                            'total_harga_addendum_26' => $value_hps_penyedia_kontrak_5['total_harga'],
