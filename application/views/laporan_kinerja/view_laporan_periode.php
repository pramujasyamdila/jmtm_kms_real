        ...
        <div class="content-wrapper" style="background-color:white">
            ...
            <section class="content">
                <div class="container-fluid">
                            ...
                            <div class="col-sm-12">
                                <div class="card card-outline card-warning">
                                    <div class="card-header">
                                        <h6> <i class="fa fa-book"></i> VIEW LAPORAN KINERJA</h6>
                                    </div>
                                    <div class="card-body">
                                        ...
                                        <div class="card card-outline card-primary">
                                            <div class="card-header">
                                                <center>
                                                    <h6>
                                                        LAPORAN REALISASI KERJA DAN BIAYA PROGRAM PERIODE
                                                    </h6>
                                                </center>
                                            </div>
                                            <!-- /.card-header -->
                                            <div class="card-body">
                                                <div style="overflow-x: auto;overflow-y: scroll;height:500px;">
                                                    ...
                                                    <a target="_blank" href="<?= base_url('laporan_kinerja/buat_excel_periode/') . $get_row_laporan_priode['id_laporan_periode'] ?>" class="btn btn-primary">EXPORT EXCEL</a>
                                                    <table class="tg mt-3" style="height:500px">
                                                        <thead>
                                                        ...
                                                        <tbody>
                                                            ...
                                                            foreach ($query_result_capex->result_array() as $value_capex) { ?>
                                                                ...
                                                                $this->db->where('tbl_laporan_sub_detail_program_penyedia_jasa.id_checking', $id_capex);
                                                                ...
                                                                foreach ($query_result_capex_detail->result_array() as $value_capex_detail) { ?>
                                                                    ...
                                                                    $this->db->from('tbl_laporan_sub_detail_program_penyedia_jasa');
                                                                    $this->db->join('tbl_laporan_detail_program_penyedia_jasa', 'tbl_laporan_detail_program_penyedia_jasa.id_detail_program_penyedia_jasa = tbl_laporan_sub_detail_program_penyedia_jasa.id_detail_program_penyedia_jasa', 'left');
                                                                    $this->db->where('tbl_laporan_sub_detail_program_penyedia_jasa.id_checking', $id_capex_detail);
                                                                    $this->db->where('tbl_laporan_detail_program_penyedia_jasa.id_laporan_periode', $get_row_laporan_priode['id_laporan_periode']);
                                                                    if ($id_departemen == 4) {
                                                                    } else {
                                                                        if ($id_departemen && $id_area == null && $id_sub_area == null) {
                                                                            $this->db->where('tbl_laporan_detail_program_penyedia_jasa.id_departemen', $id_departemen);
                                                                        } else if ($id_departemen && $id_area && $id_sub_area == null) {
                                                                            $this->db->where('tbl_laporan_detail_program_penyedia_jasa.id_departemen', $id_departemen);
                                                                            $this->db->where('tbl_laporan_detail_program_penyedia_jasa.id_area', $id_area);
                                                                    ...
                                                                    foreach ($query_result_detail_capex_1->result_array() as $value_detail_capex_1) { ?>
                                                                        ...
                                                                        $this->db->from('tbl_laporan_sub_detail_program_penyedia_jasa');
                                                                        $this->db->join('tbl_laporan_detail_program_penyedia_jasa', 'tbl_laporan_detail_program_penyedia_jasa.id_detail_program_penyedia_jasa = tbl_laporan_sub_detail_program_penyedia_jasa.id_detail_program_penyedia_jasa', 'left');
                                                                        $this->db->where('tbl_laporan_sub_detail_program_penyedia_jasa.id_checking', $id_detail_capex_1);
                                                                        $this->db->where('tbl_laporan_detail_program_penyedia_jasa.id_laporan_periode', $get_row_laporan_priode['id_laporan_periode']);
                                                                        if ($id_departemen == 4) {
                                                                        } else {
                                                                            if ($id_departemen && $id_area == null && $id_sub_area == null) {
                                                                    ...
                                                                    foreach ($query_result_detail_capex_2->result_array() as $value_detail_capex_2) { ?>
                                                                        ...
                                                                        $this->db->from('tbl_laporan_sub_detail_program_penyedia_jasa');
                                                                        $this->db->join('tbl_laporan_detail_program_penyedia_jasa', 'tbl_laporan_detail_program_penyedia_jasa.id_detail_program_penyedia_jasa = tbl_laporan_sub_detail_program_penyedia_jasa.id_detail_program_penyedia_jasa', 'left');
                                                                        $this->db->where('tbl_laporan_sub_detail_program_penyedia_jasa.id_checking', $id_detail_capex_2);
                                                                        $this->db->where('tbl_laporan_detail_program_penyedia_jasa.id_laporan_periode', $get_row_laporan_priode['id_laporan_periode']);
                                                                        if ($id_departemen == 4) {
                                                                        } else {
                                                                            if ($id_departemen && $id_area == null && $id_sub_area == null) {
                                                                    ...
                                                                    foreach ($query_result_detail_capex_3->result_array() as $value_detail_capex_3) { ?>
                                                                        ...
                                                                        $this->db->from('tbl_laporan_sub_detail_program_penyedia_jasa');
                                                                        $this->db->join('tbl_laporan_detail_program_penyedia_jasa', 'tbl_laporan_detail_program_penyedia_jasa.id_detail_program_penyedia_jasa = tbl_laporan_sub_detail_program_penyedia_jasa.id_detail_program_penyedia_jasa', 'left');
                                                                        $this->db->where('tbl_laporan_sub_detail_program_penyedia_jasa.id_checking', $id_detail_capex_3);
                                                                        $this->db->where('tbl_laporan_detail_program_penyedia_jasa.id_laporan_periode', $get_row_laporan_priode['id_laporan_periode']);
                                                                        if ($id_departemen == 4) {
                                                                        } else {
                                                                            if ($id_departemen && $id_area == null && $id_sub_area == null) {
                                                                    ...
                                                                    foreach ($query_result_detail_capex_4->result_array() as $value_detail_capex_4) { ?>
                                                                        ...
                                                                        $this->db->from('tbl_laporan_sub_detail_program_penyedia_jasa');
                                                                        $this->db->join('tbl_laporan_detail_program_penyedia_jasa', 'tbl_laporan_detail_program_penyedia_jasa.id_detail_program_penyedia_jasa = tbl_laporan_sub_detail_program_penyedia_jasa.id_detail_program_penyedia_jasa', 'left');
                                                                        $this->db->where('tbl_laporan_sub_detail_program_penyedia_jasa.id_checking', $id_detail_capex_4);
                                                                        $this->db->where('tbl_laporan_detail_program_penyedia_jasa.id_laporan_periode', $get_row_laporan_priode['id_laporan_periode']);
                                                                        if ($id_departemen == 4) {
                                                                        } else {
                                                                            if ($id_departemen && $id_area == null && $id_sub_area == null) {
                                                                    ...
                                                                    foreach ($query_result_detail_capex_5->result_array() as $value_detail_capex_5) { ?>
                                                                        ...
                                                                        $this->db->from('tbl_laporan_sub_detail_program_penyedia_jasa');
                                                                        $this->db->join('tbl_laporan_detail_program_penyedia_jasa', 'tbl_laporan_detail_program_penyedia_jasa.id_detail_program_penyedia_jasa = tbl_laporan_sub_detail_program_penyedia_jasa.id_detail_program_penyedia_jasa', 'left');
                                                                        $this->db->where('tbl_laporan_sub_detail_program_penyedia_jasa.id_checking', $id_detail_capex_5);
                                                                        $this->db->where('tbl_laporan_detail_program_penyedia_jasa.id_laporan_periode', $get_row_laporan_priode['id_laporan_periode']);
                                                                        if ($id_departemen == 4) {
                                                                        } else {
                                                                            if ($id_departemen && $id_area == null && $id_sub_area == null) {
                                                                    ...
                                                                    foreach ($query_result_detail_capex_6->result_array() as $value_detail_capex_6) { ?>
                                                                        ...
                                                                        $this->db->from('tbl_laporan_sub_detail_program_penyedia_jasa');
                                                                        $this->db->join('tbl_laporan_detail_program_penyedia_jasa', 'tbl_laporan_detail_program_penyedia_jasa.id_detail_program_penyedia_jasa = tbl_laporan_sub_detail_program_penyedia_jasa.id_detail_program_penyedia_jasa', 'left');
                                                                        $this->db->where('tbl_laporan_sub_detail_program_penyedia_jasa.id_checking', $id_detail_capex_6);
                                                                        $this->db->where('tbl_laporan_detail_program_penyedia_jasa.id_laporan_periode', $get_row_laporan_priode['id_laporan_periode']);
                                                                        if ($id_departemen == 4) {
                                                                        } else {
                                                                            if ($id_departemen && $id_area == null && $id_sub_area == null) {
                                                                    ...
                                                                    foreach ($query_result_detail_capex_7->result_array() as $value_detail_capex_7) { ?>
                                                                        ...
                                                                        $this->db->from('tbl_laporan_sub_detail_program_penyedia_jasa');
                                                                        $this->db->join('tbl_laporan_detail_program_penyedia_jasa', 'tbl_laporan_detail_program_penyedia_jasa.id_detail_program_penyedia_jasa = tbl_laporan_sub_detail_program_penyedia_jasa.id_detail_program_penyedia_jasa', 'left');
                                                                        $this->db->where('tbl_laporan_sub_detail_program_penyedia_jasa.id_checking', $id_detail_capex_7);
                                                                        $this->db->where('tbl_laporan_detail_program_penyedia_jasa.id_laporan_periode', $get_row_laporan_priode['id_laporan_periode']);
                                                                        if ($id_departemen == 4) {
                                                                        } else {
                                                                            if ($id_departemen && $id_area == null && $id_sub_area == null) {
                                                                    ...
                                                                    foreach ($query_result_detail_capex_8->result_array() as $value_detail_capex_8) { ?>
                                                                        ...
                                                                        $this->db->from('tbl_laporan_sub_detail_program_penyedia_jasa');
                                                                        $this->db->join('tbl_laporan_detail_program_penyedia_jasa', 'tbl_laporan_detail_program_penyedia_jasa.id_detail_program_penyedia_jasa = tbl_laporan_sub_detail_program_penyedia_jasa.id_detail_program_penyedia_jasa', 'left');
                                                                        $this->db->where('tbl_laporan_sub_detail_program_penyedia_jasa.id_checking', $id_detail_capex_8);
                                                                        $this->db->where('tbl_laporan_detail_program_penyedia_jasa.id_laporan_periode', $get_row_laporan_priode['id_laporan_periode']);
                                                                        if ($id_departemen == 4) {
                                                                        } else {
                                                                            if ($id_departemen && $id_area == null && $id_sub_area == null) {
                                                                    ...
                                                                    foreach ($query_result_detail_capex_9->result_array() as $value_detail_capex_9) { ?>
                                                                        ...
                                                                        $this->db->from('tbl_laporan_sub_detail_program_penyedia_jasa');
                                                                        $this->db->join('tbl_laporan_detail_program_penyedia_jasa', 'tbl_laporan_detail_program_penyedia_jasa.id_detail_program_penyedia_jasa = tbl_laporan_sub_detail_program_penyedia_jasa.id_detail_program_penyedia_jasa', 'left');
                                                                        $this->db->where('tbl_laporan_sub_detail_program_penyedia_jasa.id_checking', $id_detail_capex_9);
                                                                        $this->db->where('tbl_laporan_detail_program_penyedia_jasa.id_laporan_periode', $get_row_laporan_priode['id_laporan_periode']);
                                                                        if ($id_departemen == 4) {
                                                                        } else {
                                                                            if ($id_departemen && $id_area == null && $id_sub_area == null) {
                                                            ...
                                                            foreach ($query_result_opex->result_array() as $value_opex) { ?>
                                                                ...
                                                                $this->db->from('tbl_laporan_sub_detail_program_penyedia_jasa');
                                                                $this->db->join('tbl_laporan_detail_program_penyedia_jasa', 'tbl_laporan_detail_program_penyedia_jasa.id_detail_program_penyedia_jasa = tbl_laporan_sub_detail_program_penyedia_jasa.id_detail_program_penyedia_jasa', 'left');
                                                                $this->db->where('tbl_laporan_sub_detail_program_penyedia_jasa.id_checking', $id_opex);
                                                                ...
                                                                foreach ($query_result_opex_detail->result_array() as $value_opex_detail) { ?>
                                                                    ...
                                                                    $this->db->from('tbl_laporan_sub_detail_program_penyedia_jasa');
                                                                    $this->db->join('tbl_laporan_detail_program_penyedia_jasa', 'tbl_laporan_detail_program_penyedia_jasa.id_detail_program_penyedia_jasa = tbl_laporan_sub_detail_program_penyedia_jasa.id_detail_program_penyedia_jasa', 'left');
                                                                    $this->db->where('tbl_laporan_sub_detail_program_penyedia_jasa.id_checking', $id_opex_detail);
                                                                    $this->db->where('tbl_laporan_detail_program_penyedia_jasa.id_laporan_periode', $get_row_laporan_priode['id_laporan_periode']);
                                                                    if ($id_departemen == 4) {
                                                                    } else {
                                                                        if ($id_departemen && $id_area == null && $id_sub_area == null) {
                                                                    ...
                                                                    foreach ($query_result_detail_opex_1->result_array() as $value_detail_opex_1) { ?>
                                                                        ...
                                                                        $this->db->from('tbl_laporan_sub_detail_program_penyedia_jasa');
                                                                        $this->db->join('tbl_laporan_detail_program_penyedia_jasa', 'tbl_laporan_detail_program_penyedia_jasa.id_detail_program_penyedia_jasa = tbl_laporan_sub_detail_program_penyedia_jasa.id_detail_program_penyedia_jasa', 'left');
                                                                        $this->db->where('tbl_laporan_sub_detail_program_penyedia_jasa.id_checking', $id_detail_opex_1);
                                                                        $this->db->where('tbl_laporan_detail_program_penyedia_jasa.id_laporan_periode', $get_row_laporan_priode['id_laporan_periode']);
                                                                        if ($id_departemen == 4) {
                                                                        } else {
                                                                            if ($id_departemen && $id_area == null && $id_sub_area == null) {
                                                                    ...
                                                                    foreach ($query_result_detail_opex_2->result_array() as $value_detail_opex_2) { ?>
                                                                        ...
                                                                        $this->db->from('tbl_laporan_sub_detail_program_penyedia_jasa');
                                                                        $this->db->join('tbl_laporan_detail_program_penyedia_jasa', 'tbl_laporan_detail_program_penyedia_jasa.id_detail_program_penyedia_jasa = tbl_laporan_sub_detail_program_penyedia_jasa.id_detail_program_penyedia_jasa', 'left');
                                                                        $this->db->where('tbl_laporan_sub_detail_program_penyedia_jasa.id_checking', $id_detail_opex_2);
                                                                        $this->db->where('tbl_laporan_detail_program_penyedia_jasa.id_laporan_periode', $get_row_laporan_priode['id_laporan_periode']);
                                                                        if ($id_departemen == 4) {
                                                                        } else {
                                                                            if ($id_departemen && $id_area == null && $id_sub_area == null) {
                                                                    ...
                                                                    foreach ($query_result_detail_opex_3->result_array() as $value_detail_opex_3) { ?>
                                                                        ...
                                                                        $this->db->from('tbl_laporan_sub_detail_program_penyedia_jasa');
                                                                        $this->db->join('tbl_laporan_detail_program_penyedia_jasa', 'tbl_laporan_detail_program_penyedia_jasa.id_detail_program_penyedia_jasa = tbl_laporan_sub_detail_program_penyedia_jasa.id_detail_program_penyedia_jasa', 'left');
                                                                        $this->db->where('tbl_laporan_sub_detail_program_penyedia_jasa.id_checking', $id_detail_opex_3);
                                                                        $this->db->where('tbl_laporan_detail_program_penyedia_jasa.id_laporan_periode', $get_row_laporan_priode['id_laporan_periode']);
                                                                        if ($id_departemen == 4) {
                                                                        } else {
                                                                            if ($id_departemen && $id_area == null && $id_sub_area == null) {
                                                                    ...
                                                                    foreach ($query_result_detail_opex_4->result_array() as $value_detail_opex_4) { ?>
                                                                        ...
                                                                        $this->db->from('tbl_laporan_sub_detail_program_penyedia_jasa');
                                                                        $this->db->join('tbl_laporan_detail_program_penyedia_jasa', 'tbl_laporan_detail_program_penyedia_jasa.id_detail_program_penyedia_jasa = tbl_laporan_sub_detail_program_penyedia_jasa.id_detail_program_penyedia_jasa', 'left');
                                                                        $this->db->where('tbl_laporan_sub_detail_program_penyedia_jasa.id_checking', $id_detail_opex_4);
                                                                        $this->db->where('tbl_laporan_detail_program_penyedia_jasa.id_laporan_periode', $get_row_laporan_priode['id_laporan_periode']);
                                                                        if ($id_departemen == 4) {
                                                                        } else {
                                                                            if ($id_departemen && $id_area == null && $id_sub_area == null) {
                                                                    ...
                                                                    foreach ($query_result_detail_opex_5->result_array() as $value_detail_opex_5) { ?>
                                                                        ...
                                                                        $this->db->from('tbl_laporan_sub_detail_program_penyedia_jasa');
                                                                        $this->db->join('tbl_laporan_detail_program_penyedia_jasa', 'tbl_laporan_detail_program_penyedia_jasa.id_detail_program_penyedia_jasa = tbl_laporan_sub_detail_program_penyedia_jasa.id_detail_program_penyedia_jasa', 'left');
                                                                        $this->db->where('tbl_laporan_sub_detail_program_penyedia_jasa.id_checking', $id_detail_opex_5);
                                                                        $this->db->where('tbl_laporan_detail_program_penyedia_jasa.id_laporan_periode', $get_row_laporan_priode['id_laporan_periode']);
                                                                        if ($id_departemen == 4) {
                                                                        } else {
                                                                            if ($id_departemen && $id_area == null && $id_sub_area == null) {
                                                                    ...
                                                                    foreach ($query_result_detail_opex_6->result_array() as $value_detail_opex_6) { ?>
                                                                        ...
                                                                        $this->db->from('tbl_laporan_sub_detail_program_penyedia_jasa');
                                                                        $this->db->join('tbl_laporan_detail_program_penyedia_jasa', 'tbl_laporan_detail_program_penyedia_jasa.id_detail_program_penyedia_jasa = tbl_laporan_sub_detail_program_penyedia_jasa.id_detail_program_penyedia_jasa', 'left');
                                                                        $this->db->where('tbl_laporan_sub_detail_program_penyedia_jasa.id_checking', $id_detail_opex_6);
                                                                        $this->db->where('tbl_laporan_detail_program_penyedia_jasa.id_laporan_periode', $get_row_laporan_priode['id_laporan_periode']);
                                                                        if ($id_departemen == 4) {
                                                                        } else {
                                                                            if ($id_departemen && $id_area == null && $id_sub_area == null) {
                                                                    ...
                                                                    foreach ($query_result_detail_opex_7->result_array() as $value_detail_opex_7) { ?>
                                                                        ...
                                                                        $this->db->from('tbl_laporan_sub_detail_program_penyedia_jasa');
                                                                        $this->db->join('tbl_laporan_detail_program_penyedia_jasa', 'tbl_laporan_detail_program_penyedia_jasa.id_detail_program_penyedia_jasa = tbl_laporan_sub_detail_program_penyedia_jasa.id_detail_program_penyedia_jasa', 'left');
                                                                        $this->db->where('tbl_laporan_sub_detail_program_penyedia_jasa.id_checking', $id_detail_opex_7);
                                                                        $this->db->where('tbl_laporan_detail_program_penyedia_jasa.id_laporan_periode', $get_row_laporan_priode['id_laporan_periode']);
                                                                        if ($id_departemen == 4) {
                                                                        } else {
                                                                            if ($id_departemen && $id_area == null && $id_sub_area == null) {
                                                                    ...
                                                                    foreach ($query_result_detail_opex_8->result_array() as $value_detail_opex_8) { ?>
                                                                        ...
                                                                        $this->db->from('tbl_laporan_sub_detail_program_penyedia_jasa');
                                                                        $this->db->join('tbl_laporan_detail_program_penyedia_jasa', 'tbl_laporan_detail_program_penyedia_jasa.id_detail_program_penyedia_jasa = tbl_laporan_sub_detail_program_penyedia_jasa.id_detail_program_penyedia_jasa', 'left');
                                                                        $this->db->where('tbl_laporan_sub_detail_program_penyedia_jasa.id_checking', $id_detail_opex_8);
                                                                        $this->db->where('tbl_laporan_detail_program_penyedia_jasa.id_laporan_periode', $get_row_laporan_priode['id_laporan_periode']);
                                                                        if ($id_departemen == 4) {
                                                                        } else {
                                                                            if ($id_departemen && $id_area == null && $id_sub_area == null) {
                                                                    ...
                                                                    foreach ($query_result_detail_opex_9->result_array() as $value_detail_opex_9) { ?>
                                                                        ...
                                                                        $this->db->from('tbl_laporan_sub_detail_program_penyedia_jasa');
                                                                        $this->db->join('tbl_laporan_detail_program_penyedia_jasa', 'tbl_laporan_detail_program_penyedia_jasa.id_detail_program_penyedia_jasa = tbl_laporan_sub_detail_program_penyedia_jasa.id_detail_program_penyedia_jasa', 'left');
                                                                        $this->db->where('tbl_laporan_sub_detail_program_penyedia_jasa.id_checking', $id_detail_opex_9);
                                                                        $this->db->where('tbl_laporan_detail_program_penyedia_jasa.id_laporan_periode', $get_row_laporan_priode['id_laporan_periode']);
                                                                        if ($id_departemen == 4) {
                                                                        } else {
                                                                            if ($id_departemen && $id_area == null && $id_sub_area == null) {
                                                            ...
                                                            foreach ($query_result_bua->result_array() as $value_bua) { ?>
                                                                ...
                                                                $this->db->from('tbl_laporan_sub_detail_program_penyedia_jasa');
                                                                $this->db->join('tbl_laporan_detail_program_penyedia_jasa', 'tbl_laporan_detail_program_penyedia_jasa.id_detail_program_penyedia_jasa = tbl_laporan_sub_detail_program_penyedia_jasa.id_detail_program_penyedia_jasa', 'left');
                                                                $this->db->where('tbl_laporan_sub_detail_program_penyedia_jasa.id_checking', $id_bua);
                                                                ...
                                                                foreach ($query_result_bua_detail->result_array() as $value_bua_detail) { ?>
                                                                    ...
                                                                    $this->db->from('tbl_laporan_sub_detail_program_penyedia_jasa');
                                                                    $this->db->join('tbl_laporan_detail_program_penyedia_jasa', 'tbl_laporan_detail_program_penyedia_jasa.id_detail_program_penyedia_jasa = tbl_laporan_sub_detail_program_penyedia_jasa.id_detail_program_penyedia_jasa', 'left');
                                                                    $this->db->where('tbl_laporan_sub_detail_program_penyedia_jasa.id_checking', $id_bua_detail);
                                                                    $this->db->where('tbl_laporan_detail_program_penyedia_jasa.id_laporan_periode', $get_row_laporan_priode['id_laporan_periode']);
                                                                    if ($id_departemen == 4) {
                                                                    } else {
                                                                        if ($id_departemen && $id_area == null && $id_sub_area == null) {
                                                                    ...
                                                                    foreach ($query_result_detail_bua_1->result_array() as $value_detail_bua_1) { ?>
                                                                        ...
                                                                        $this->db->from('tbl_laporan_sub_detail_program_penyedia_jasa');
                                                                        $this->db->join('tbl_laporan_detail_program_penyedia_jasa', 'tbl_laporan_detail_program_penyedia_jasa.id_detail_program_penyedia_jasa = tbl_laporan_sub_detail_program_penyedia_jasa.id_detail_program_penyedia_jasa', 'left');
                                                                        $this->db->where('tbl_laporan_sub_detail_program_penyedia_jasa.id_checking', $id_detail_bua_1);
                                                                        $this->db->where('tbl_laporan_detail_program_penyedia_jasa.id_laporan_periode', $get_row_laporan_priode['id_laporan_periode']);
                                                                        if ($id_departemen == 4) {
                                                                        } else {
                                                                            if ($id_departemen && $id_area == null && $id_sub_area == null) {
                                                                    ...
                                                                    foreach ($query_result_detail_bua_2->result_array() as $value_detail_bua_2) { ?>
                                                                        ...
                                                                        $this->db->from('tbl_laporan_sub_detail_program_penyedia_jasa');
                                                                        $this->db->join('tbl_laporan_detail_program_penyedia_jasa', 'tbl_laporan_detail_program_penyedia_jasa.id_detail_program_penyedia_jasa = tbl_laporan_sub_detail_program_penyedia_jasa.id_detail_program_penyedia_jasa', 'left');
                                                                        $this->db->where('tbl_laporan_sub_detail_program_penyedia_jasa.id_checking', $id_detail_bua_2);
                                                                        $this->db->where('tbl_laporan_detail_program_penyedia_jasa.id_laporan_periode', $get_row_laporan_priode['id_laporan_periode']);
                                                                        if ($id_departemen == 4) {
                                                                        } else {
                                                                            if ($id_departemen && $id_area == null && $id_sub_area == null) {
                                                                    ...
                                                                    foreach ($query_result_detail_bua_3->result_array() as $value_detail_bua_3) { ?>
                                                                        ...
                                                                        $this->db->from('tbl_laporan_sub_detail_program_penyedia_jasa');
                                                                        $this->db->join('tbl_laporan_detail_program_penyedia_jasa', 'tbl_laporan_detail_program_penyedia_jasa.id_detail_program_penyedia_jasa = tbl_laporan_sub_detail_program_penyedia_jasa.id_detail_program_penyedia_jasa', 'left');
                                                                        $this->db->where('tbl_laporan_sub_detail_program_penyedia_jasa.id_checking', $id_detail_bua_3);
                                                                        $this->db->where('tbl_laporan_detail_program_penyedia_jasa.id_laporan_periode', $get_row_laporan_priode['id_laporan_periode']);
                                                                        if ($id_departemen == 4) {
                                                                        } else {
                                                                            if ($id_departemen && $id_area == null && $id_sub_area == null) {
                                                                    ...
                                                                    foreach ($query_result_detail_bua_4->result_array() as $value_detail_bua_4) { ?>
                                                                        ...
                                                                        $this->db->from('tbl_laporan_sub_detail_program_penyedia_jasa');
                                                                        $this->db->join('tbl_laporan_detail_program_penyedia_jasa', 'tbl_laporan_detail_program_penyedia_jasa.id_detail_program_penyedia_jasa = tbl_laporan_sub_detail_program_penyedia_jasa.id_detail_program_penyedia_jasa', 'left');
                                                                        $this->db->where('tbl_laporan_sub_detail_program_penyedia_jasa.id_checking', $id_detail_bua_4);
                                                                        $this->db->where('tbl_laporan_detail_program_penyedia_jasa.id_laporan_periode', $get_row_laporan_priode['id_laporan_periode']);
                                                                        if ($id_departemen == 4) {
                                                                        } else {
                                                                            if ($id_departemen && $id_area == null && $id_sub_area == null) {
                                                                    ...
                                                                    foreach ($query_result_detail_bua_5->result_array() as $value_detail_bua_5) { ?>
                                                                        ...
                                                                        $this->db->from('tbl_laporan_sub_detail_program_penyedia_jasa');
                                                                        $this->db->join('tbl_laporan_detail_program_penyedia_jasa', 'tbl_laporan_detail_program_penyedia_jasa.id_detail_program_penyedia_jasa = tbl_laporan_sub_detail_program_penyedia_jasa.id_detail_program_penyedia_jasa', 'left');
                                                                        $this->db->where('tbl_laporan_sub_detail_program_penyedia_jasa.id_checking', $id_detail_bua_5);
                                                                        $this->db->where('tbl_laporan_detail_program_penyedia_jasa.id_laporan_periode', $get_row_laporan_priode['id_laporan_periode']);
                                                                        if ($id_departemen == 4) {
                                                                        } else {
                                                                            if ($id_departemen && $id_area == null && $id_sub_area == null) {
                                                                    ...
                                                                    foreach ($query_result_detail_bua_6->result_array() as $value_detail_bua_6) { ?>
                                                                        ...
                                                                        $this->db->from('tbl_laporan_sub_detail_program_penyedia_jasa');
                                                                        $this->db->join('tbl_laporan_detail_program_penyedia_jasa', 'tbl_laporan_detail_program_penyedia_jasa.id_detail_program_penyedia_jasa = tbl_laporan_sub_detail_program_penyedia_jasa.id_detail_program_penyedia_jasa', 'left');
                                                                        $this->db->where('tbl_laporan_sub_detail_program_penyedia_jasa.id_checking', $id_detail_bua_6);
                                                                        $this->db->where('tbl_laporan_detail_program_penyedia_jasa.id_laporan_periode', $get_row_laporan_priode['id_laporan_periode']);
                                                                        if ($id_departemen == 4) {
                                                                        } else {
                                                                            if ($id_departemen && $id_area == null && $id_sub_area == null) {
                                                                    ...
                                                                    foreach ($query_result_detail_bua_7->result_array() as $value_detail_bua_7) { ?>
                                                                        ...
                                                                        $this->db->from('tbl_laporan_sub_detail_program_penyedia_jasa');
                                                                        $this->db->join('tbl_laporan_detail_program_penyedia_jasa', 'tbl_laporan_detail_program_penyedia_jasa.id_detail_program_penyedia_jasa = tbl_laporan_sub_detail_program_penyedia_jasa.id_detail_program_penyedia_jasa', 'left');
                                                                        $this->db->where('tbl_laporan_sub_detail_program_penyedia_jasa.id_checking', $id_detail_bua_7);
                                                                        $this->db->where('tbl_laporan_detail_program_penyedia_jasa.id_laporan_periode', $get_row_laporan_priode['id_laporan_periode']);
                                                                        if ($id_departemen == 4) {
                                                                        } else {
                                                                            if ($id_departemen && $id_area == null && $id_sub_area == null) {
                                                                    ...
                                                                    foreach ($query_result_detail_bua_8->result_array() as $value_detail_bua_8) { ?>
                                                                        ...
                                                                        $this->db->from('tbl_laporan_sub_detail_program_penyedia_jasa');
                                                                        $this->db->join('tbl_laporan_detail_program_penyedia_jasa', 'tbl_laporan_detail_program_penyedia_jasa.id_detail_program_penyedia_jasa = tbl_laporan_sub_detail_program_penyedia_jasa.id_detail_program_penyedia_jasa', 'left');
                                                                        $this->db->where('tbl_laporan_sub_detail_program_penyedia_jasa.id_checking', $id_detail_bua_8);
                                                                        $this->db->where('tbl_laporan_detail_program_penyedia_jasa.id_laporan_periode', $get_row_laporan_priode['id_laporan_periode']);
                                                                        if ($id_departemen == 4) {
                                                                        } else {
                                                                            if ($id_departemen && $id_area == null && $id_sub_area == null) {
                                                                    ...
                                                                    foreach ($query_result_detail_bua_9->result_array() as $value_detail_bua_9) { ?>
                                                                        ...
                                                                        $this->db->from('tbl_laporan_sub_detail_program_penyedia_jasa');
                                                                        $this->db->join('tbl_laporan_detail_program_penyedia_jasa', 'tbl_laporan_detail_program_penyedia_jasa.id_detail_program_penyedia_jasa = tbl_laporan_sub_detail_program_penyedia_jasa.id_detail_program_penyedia_jasa', 'left');
                                                                        $this->db->where('tbl_laporan_sub_detail_program_penyedia_jasa.id_checking', $id_detail_bua_9);
                                                                        $this->db->where('tbl_laporan_detail_program_penyedia_jasa.id_laporan_periode', $get_row_laporan_priode['id_laporan_periode']);
                                                                        if ($id_departemen == 4) {
                                                                        } else {
                                                                            if ($id_departemen && $id_area == null && $id_sub_area == null) {
                                                            ...
                                                            foreach ($query_result_sdm->result_array() as $value_sdm) { ?>
                                                                ...
                                                                $this->db->from('tbl_laporan_sub_detail_program_penyedia_jasa');
                                                                $this->db->join('tbl_laporan_detail_program_penyedia_jasa', 'tbl_laporan_detail_program_penyedia_jasa.id_detail_program_penyedia_jasa = tbl_laporan_sub_detail_program_penyedia_jasa.id_detail_program_penyedia_jasa', 'left');
                                                                $this->db->where('tbl_laporan_sub_detail_program_penyedia_jasa.id_checking', $id_sdm);
                                                                ...
                                                                foreach ($query_result_sdm_detail->result_array() as $value_sdm_detail) { ?>
                                                                    ...
                                                                    $this->db->from('tbl_laporan_sub_detail_program_penyedia_jasa');
                                                                    $this->db->join('tbl_laporan_detail_program_penyedia_jasa', 'tbl_laporan_detail_program_penyedia_jasa.id_detail_program_penyedia_jasa = tbl_laporan_sub_detail_program_penyedia_jasa.id_detail_program_penyedia_jasa', 'left');
                                                                    $this->db->where('tbl_laporan_sub_detail_program_penyedia_jasa.id_checking', $id_sdm_detail);
                                                                    $this->db->where('tbl_laporan_detail_program_penyedia_jasa.id_laporan_periode', $get_row_laporan_priode['id_laporan_periode']);
                                                                    if ($id_departemen == 4) {
                                                                    } else {
                                                                        if ($id_departemen && $id_area == null && $id_sub_area == null) {
                                                                    ...
                                                                    foreach ($query_result_detail_sdm_1->result_array() as $value_detail_sdm_1) { ?>
                                                                        ...
                                                                        $this->db->from('tbl_laporan_sub_detail_program_penyedia_jasa');
                                                                        $this->db->join('tbl_laporan_detail_program_penyedia_jasa', 'tbl_laporan_detail_program_penyedia_jasa.id_detail_program_penyedia_jasa = tbl_laporan_sub_detail_program_penyedia_jasa.id_detail_program_penyedia_jasa', 'left');
                                                                        $this->db->where('tbl_laporan_sub_detail_program_penyedia_jasa.id_checking', $id_detail_sdm_1);
                                                                        $this->db->where('tbl_laporan_detail_program_penyedia_jasa.id_laporan_periode', $get_row_laporan_priode['id_laporan_periode']);
                                                                        if ($id_departemen == 4) {
                                                                        } else {
                                                                            if ($id_departemen && $id_area == null && $id_sub_area == null) {
                                                                    ...
                                                                    foreach ($query_result_detail_sdm_2->result_array() as $value_detail_sdm_2) { ?>
                                                                        ...
                                                                        $this->db->from('tbl_laporan_sub_detail_program_penyedia_jasa');
                                                                        $this->db->join('tbl_laporan_detail_program_penyedia_jasa', 'tbl_laporan_detail_program_penyedia_jasa.id_detail_program_penyedia_jasa = tbl_laporan_sub_detail_program_penyedia_jasa.id_detail_program_penyedia_jasa', 'left');
                                                                        $this->db->where('tbl_laporan_sub_detail_program_penyedia_jasa.id_checking', $id_detail_sdm_2);
                                                                        $this->db->where('tbl_laporan_detail_program_penyedia_jasa.id_laporan_periode', $get_row_laporan_priode['id_laporan_periode']);
                                                                        if ($id_departemen == 4) {
                                                                        } else {
                                                                            if ($id_departemen && $id_area == null && $id_sub_area == null) {
                                                                    ...
                                                                    foreach ($query_result_detail_sdm_3->result_array() as $value_detail_sdm_3) { ?>
                                                                        ...
                                                                        $this->db->from('tbl_laporan_sub_detail_program_penyedia_jasa');
                                                                        $this->db->join('tbl_laporan_detail_program_penyedia_jasa', 'tbl_laporan_detail_program_penyedia_jasa.id_detail_program_penyedia_jasa = tbl_laporan_sub_detail_program_penyedia_jasa.id_detail_program_penyedia_jasa', 'left');
                                                                        $this->db->where('tbl_laporan_sub_detail_program_penyedia_jasa.id_checking', $id_detail_sdm_3);
                                                                        $this->db->where('tbl_laporan_detail_program_penyedia_jasa.id_laporan_periode', $get_row_laporan_priode['id_laporan_periode']);
                                                                        if ($id_departemen == 4) {
                                                                        } else {
                                                                            if ($id_departemen && $id_area == null && $id_sub_area == null) {
                                                                    ...
                                                                    foreach ($query_result_detail_sdm_4->result_array() as $value_detail_sdm_4) { ?>
                                                                        ...
                                                                        $this->db->from('tbl_laporan_sub_detail_program_penyedia_jasa');
                                                                        $this->db->join('tbl_laporan_detail_program_penyedia_jasa', 'tbl_laporan_detail_program_penyedia_jasa.id_detail_program_penyedia_jasa = tbl_laporan_sub_detail_program_penyedia_jasa.id_detail_program_penyedia_jasa', 'left');
                                                                        $this->db->where('tbl_laporan_sub_detail_program_penyedia_jasa.id_checking', $id_detail_sdm_4);
                                                                        $this->db->where('tbl_laporan_detail_program_penyedia_jasa.id_laporan_periode', $get_row_laporan_priode['id_laporan_periode']);
                                                                        if ($id_departemen == 4) {
                                                                        } else {
                                                                            if ($id_departemen && $id_area == null && $id_sub_area == null) {
                                                                    ...
                                                                    foreach ($query_result_detail_sdm_5->result_array() as $value_detail_sdm_5) { ?>
                                                                        ...
                                                                        $this->db->from('tbl_laporan_sub_detail_program_penyedia_jasa');
                                                                        $this->db->join('tbl_laporan_detail_program_penyedia_jasa', 'tbl_laporan_detail_program_penyedia_jasa.id_detail_program_penyedia_jasa = tbl_laporan_sub_detail_program_penyedia_jasa.id_detail_program_penyedia_jasa', 'left');
                                                                        $this->db->where('tbl_laporan_sub_detail_program_penyedia_jasa.id_checking', $id_detail_sdm_5);
                                                                        $this->db->where('tbl_laporan_detail_program_penyedia_jasa.id_laporan_periode', $get_row_laporan_priode['id_laporan_periode']);
                                                                        if ($id_departemen == 4) {
                                                                        } else {
                                                                            if ($id_departemen && $id_area == null && $id_sub_area == null) {
                                                                    ...
                                                                    foreach ($query_result_detail_sdm_6->result_array() as $value_detail_sdm_6) { ?>
                                                                        ...
                                                                        $this->db->from('tbl_laporan_sub_detail_program_penyedia_jasa');
                                                                        $this->db->join('tbl_laporan_detail_program_penyedia_jasa', 'tbl_laporan_detail_program_penyedia_jasa.id_detail_program_penyedia_jasa = tbl_laporan_sub_detail_program_penyedia_jasa.id_detail_program_penyedia_jasa', 'left');
                                                                        $this->db->where('tbl_laporan_sub_detail_program_penyedia_jasa.id_checking', $id_detail_sdm_6);
                                                                        $this->db->where('tbl_laporan_detail_program_penyedia_jasa.id_laporan_periode', $get_row_laporan_priode['id_laporan_periode']);
                                                                        if ($id_departemen == 4) {
                                                                        } else {
                                                                            if ($id_departemen && $id_area == null && $id_sub_area == null) {
                                                                    ...
                                                                    foreach ($query_result_detail_sdm_7->result_array() as $value_detail_sdm_7) { ?>
                                                                        ...
                                                                        $this->db->from('tbl_laporan_sub_detail_program_penyedia_jasa');
                                                                        $this->db->join('tbl_laporan_detail_program_penyedia_jasa', 'tbl_laporan_detail_program_penyedia_jasa.id_detail_program_penyedia_jasa = tbl_laporan_sub_detail_program_penyedia_jasa.id_detail_program_penyedia_jasa', 'left');
                                                                        $this->db->where('tbl_laporan_sub_detail_program_penyedia_jasa.id_checking', $id_detail_sdm_7);
                                                                        $this->db->where('tbl_laporan_detail_program_penyedia_jasa.id_laporan_periode', $get_row_laporan_priode['id_laporan_periode']);
                                                                        if ($id_departemen == 4) {
                                                                        } else {
                                                                            if ($id_departemen && $id_area == null && $id_sub_area == null) {
                                                                    ...
                                                                    foreach ($query_result_detail_sdm_8->result_array() as $value_detail_sdm_8) { ?>
                                                                        ...
                                                                        $this->db->from('tbl_laporan_sub_detail_program_penyedia_jasa');
                                                                        $this->db->join('tbl_laporan_detail_program_penyedia_jasa', 'tbl_laporan_detail_program_penyedia_jasa.id_detail_program_penyedia_jasa = tbl_laporan_sub_detail_program_penyedia_jasa.id_detail_program_penyedia_jasa', 'left');
                                                                        $this->db->where('tbl_laporan_sub_detail_program_penyedia_jasa.id_checking', $id_detail_sdm_8);
                                                                        $this->db->where('tbl_laporan_detail_program_penyedia_jasa.id_laporan_periode', $get_row_laporan_priode['id_laporan_periode']);
                                                                        if ($id_departemen == 4) {
                                                                        } else {
                                                                            if ($id_departemen && $id_area == null && $id_sub_area == null) {
                                                                    ...
                                                                    foreach ($query_result_detail_sdm_9->result_array() as $value_detail_sdm_9) { ?>
                                                                        ...
                                                                        $this->db->from('tbl_laporan_sub_detail_program_penyedia_jasa');
                                                                        $this->db->join('tbl_laporan_detail_program_penyedia_jasa', 'tbl_laporan_detail_program_penyedia_jasa.id_detail_program_penyedia_jasa = tbl_laporan_sub_detail_program_penyedia_jasa.id_detail_program_penyedia_jasa', 'left');
                                                                        $this->db->where('tbl_laporan_sub_detail_program_penyedia_jasa.id_checking', $id_detail_sdm_9);
                                                                        $this->db->where('tbl_laporan_detail_program_penyedia_jasa.id_laporan_periode', $get_row_laporan_priode['id_laporan_periode']);
                                                                        if ($id_departemen == 4) {
                                                                        } else {
                                                                            if ($id_departemen && $id_area == null && $id_sub_area == null) {
                    ...
                    <!-- Modal -->
                    <div class="modal fade" id="modal_buat_periode" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form action="javascript:;" id="form_modal_buat_periode">
                                        <input type="text" name="id_kontrak" class="form-control">
                                    ...
                                    <div class="container-fluid">
                                        <form action="javascript:;" id="form_progres_fisik" method="post">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="number" name="nilai_kontrak_km" id="" class="form-control" placeholder="Masukan Nilai Km">
                                                <br>
                    ...
                    <div class="modal fade" id="modal_keterangan" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header bg-primary text-white">
